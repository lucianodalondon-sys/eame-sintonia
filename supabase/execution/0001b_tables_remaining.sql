-- SINTONIA EAME · EXECUCAO EM PARTES · BLOCO B DE 5 (TABELAS RESTANTES)
--
...
--
-- PARA QUE: as tabelas que faltam. Nenhuma FK aqui: as chaves estrangeiras vem no bloco c, entao a ordem entre as tabelas nao importa.
--
