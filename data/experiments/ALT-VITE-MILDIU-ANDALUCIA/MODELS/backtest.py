#!/usr/bin/env python3
"""
Honest backtest harness for a SEASONAL (12M/24M) outlook on Andalucian vine mildiu.

Identical machinery to the Veneto pilot, pointed at a quantitative 20-season outcome.
