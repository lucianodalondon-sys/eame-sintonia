## head  (portale.html 2973-3022, 50 lines) — §3 · ITALY_APP_MODEL is now the only place this block takes a fact from
...
## narrative  (portale.html 3023-3062, 40 lines) — §THE NARRATIVE RULE
...
## pest  (portale.html 3063-3078, 16 lines) — §4 · the pest/disease/weed tile is decorate()'s job
MUST STILL DEFINE (later blocks read these): appwin, p
MAY READ FROM EARLIER BLOCKS: APPWIN_LAB, EITHER, T, p, s

## products+window+evidence  (portale.html 3079-3151, 73 lines) — §10 · an empty ADAMA_PRODUCTS is NOT "ADAMA has no product"
...
## legacy  (portale.html 3152-3158, 7 lines) — §5 · the 29 legacy presentation cases
MUST STILL DEFINE (later blocks read these): A_OPPSCEN
MAY READ FROM EARLIER BLOCKS: A_OPPREAL, s

## live  (portale.html 3159-3162, 4 lines) — §19 · Live switch
MUST STILL DEFINE (later blocks read these): CASES
MAY READ FROM EARLIER BLOCKS: A_OPPREAL, A_OPPSCEN

## lang  (portale.html 3163-3286, 124 lines) — §27 · The switch set <html lang>
...
## radarfilter  (portale.html 3287-3568, 282 lines) — ---- radar filtering
MUST STILL DEFINE (later blocks read these): ACTS_DATED, ACT_UNDATED, CA, LV, OPPC, OPP_SEGS, RADAR_PAGE, REL, SRC_ACCESS, SRC_GROUP, WIN_REGION, WIN_STATUS, actAge, candL, cnt, cropCanon, filtered, hasFilters, match, o, oppCandidateN, oppRejectedN, oppRejectedRenderable, oppSafeDeclared, oppSafeN, oppSeg, oppSegCount, oppTotalN, oppUrgentDrawn, oppUrgentOnRejected, oppVerifiedDrawn, oppVerifiedN, recentN, recs, relBy, tally, tone, v, verified, visibleCases
MAY READ FROM EARLIER BLOCKS: CASES, EITHER, T, agoLbl, cl, d, daysAgo, k, narOf, out, q, s

## reach  (portale.html 3569-3789, 221 lines) — §9 · REACHED_IN_ITALY (414) and the 89 multi-country
MUST STILL DEFINE (later blocks read these): ICO, K, REGION_GRID, accent, goWindows, kpis, live, n, o, on, regionTiles
MAY READ FROM EARLIER BLOCKS: ACT_UNDATED, CA, CASES, D, EITHER, LV, OPPC, OPP_SEGS, RADAR_PAGE, REL, SRC_ACCESS, SRC_GROUP, T, WIN_REGION, WIN_STATUS, cnt, filtered, k, narOf, o, oppCandidateN, oppRejectedN, oppRejectedRenderable, oppSafeDeclared, oppSafeN, oppSeg, oppSegCount, oppTotalN, oppUrgentDrawn, oppUrgentOnRejected, oppVerifiedDrawn, oppVerifiedN, recentN, relBy, s, tally, verified, visibleCases, wst

## marketpanel  (portale.html 3790-3807, 18 lines) — §8 · the panel publishes its own denominator
...
## markettemp  (portale.html 3808-3827, 20 lines) — §8/§13 · market "temperature" was an editorial fixture
...
## competitor  (portale.html 3828-3888, 61 lines) — §9 · REACHED_IN_ITALY (414) is not the same claim
MUST STILL DEFINE (later blocks read these): actDeco, age, ch, ev, hasDate, reached
MAY READ FROM EARLIER BLOCKS: CH, EITHER, EVBY, NOT_ASSESSED, T, TIMING, absenceRule, actAge, agoLbl, cl, il, initials, n, noMatchLab, noWindowLead, notEnough, o, on, s

## navgroup  (portale.html 3889-3945, 57 lines) — §1 · Core = external intelligence
MUST STILL DEFINE (later blocks read these): allMessages, recentActivity
MAY READ FROM EARLIER BLOCKS: ACTS_DATED, T, actAge, actDeco, on, s, verified

## sources  (portale.html 3946-3981, 36 lines) — §8 · 'sources' counts the source REGISTRY
MUST STILL DEFINE (later blocks read these): navDef
MAY READ FROM EARLIER BLOCKS: T, k, note, on, s, verified

## navbadges  (portale.html 3982-3982, 1 lines) — const navIntegrations = 
MUST STILL DEFINE (later blocks read these): navIntegrations
MAY READ FROM EARLIER BLOCKS: T, allMessages

## accents  (portale.html 3983-3985, 3 lines) — §4 · The green/amber accents
MUST STILL DEFINE (later blocks read these): activeOf, nav, on
MAY READ FROM EARLIER BLOCKS: n, navDef, on, s

## detail  (portale.html 3986-4031, 46 lines) — §2 · The detail must open the SAME entity the card opened
MUST STILL DEFINE (later blocks read these): csLK, csRec, csScen, csUIK, navIntegrationItems, on
MAY READ FROM EARLIER BLOCKS: K, activeOf, candL, n, narOf, navIntegrations, o, on, s, verified

## opportunity  (portale.html 4032-4095, 64 lines) — §11 · The upstream opportunity feed was researched in Portuguese
MUST STILL DEFINE (later blocks read these): CS_ENUM, csFold, csSafe, csT, x
MAY READ FROM EARLIER BLOCKS: K, L, T, d, k, n, o, on, p, s, v

## crops  (portale.html 4096-4122, 27 lines) — §11 · Six crop vocabularies are measured
...
## canonwindow  (portale.html 4123-4154, 32 lines) — §13 · The canonical window is a DECLARED relation
...
## category  (portale.html 4155-4167, 13 lines) — §4 · Category tint
...
## days  (portale.html 4168-4177, 10 lines) — §7 · Days remaining, bar width and ordering
...
## adama  (portale.html 4178-4253, 76 lines) — §10 · Two real sources, in this order
...
## convergence+absence+brief+rows  (portale.html 4254-4752, 499 lines) — §2 · The five-bar convergence chart
...
MAY READ FROM EARLIER BLOCKS: D, L, REGION_GRID, T, absenceRule, accent, age, cl, cs0, csAlts, csCat, csCatKey, csCropK, csCropTxt, csD0, csDate, csDoc, csEnum, csEvN, csFresh, csIdent, csIssueK, csIssueTxt, csKnowN, csNamed, csObsDate, csPct, csPrimary, csProds, csRec, csRegion, csSafe, csScen, csSciTxt, csSrcRows, csStTok, csStatus, csT, csUIK, csWatchN, csWinRec, d, dst, e, il, k, live, match, moa, n, o, obs, on, out, p, s, t, tone, v, verified, w, wst, x

## windowscreen  (portale.html 4753-5032, 280 lines) — §9 · Every window on this screen is now AM.collections.cropWindows
...
MAY READ FROM EARLIER BLOCKS: CAL_TODAY, COV_LAB, CW_DEPTS, CW_INTERP, D, LC, START, T, a, absenceRule, actStateL, addD, calWins, cl, cs, cs0, d, deptName, dst, dw0, dwC, dwSrc, dwW, e, filtered, first, il, k, l, match, moa, n, note, o, on, out, p, prepLineOf, prods, pst, raw, reached, reasonL, s, sub, t, uniq, v, verified, w, wst, x, y

## futurecard  (portale.html 5033-5066, 34 lines) — §18 · A real Future card opens the SAME real entity
...
## major7+marketpulse  (portale.html 5067-5187, 121 lines) — §3 · MAJOR 7 · This screen was written against
...
## portfoliopanel+convergencelabel+marketgaps+signaljoin+industry  (portale.html 5188-5452, 265 lines) — §M · The portfolio panel used to list demo case products
...
MAY READ FROM EARLIER BLOCKS: MK, MK_BY, MK_CROPS, MK_FRESH, MK_LINKS, MK_OBS, MK_SRC, MK_SUMS, MK_TOK, T, a, bars, best, cnt, d, e, first, fresh, il, k, l, live, match, mkDay, mkFreq, mkIT, mkNotIngested, mkNum, mkPct, mkSpan, mp, n, note, o, on, p, r, rows, s, t, v, w, was, wins, wst, x, y

## productintel  (portale.html 5453-5844, 392 lines) — §4 · ADAMA Product Intelligence — TWO UNIVERSES OVER ONE NAME
MUST STILL DEFINE (later blocks read these): PIT, RES, a, aiTxt, cpMarketObj, e, ev, evidence, hit, iso, k, moaNote, n, nm, none, parts, pd, rejected, related, row, sp, stopped, table, uniLaw, v, verified, wins, x
MAY READ FROM EARLIER BLOCKS: D, MK_OBS, MK_SRC, N, T, a, cl, d, e, ev, first, g, held, il, k, keys, l, mkFreq, mkIT, moa, n, note, o, on, other, p, r, reached, reg, rows, s, sub, v, verified, was, why, wins, wst, x

## portafoglio  (portale.html 5845-6024, 180 lines) — §4 · Portafoglio — TWO UNIVERSES, ONE SCREEN, NEVER ONE NUMBER
MUST STILL DEFINE (later blocks read these): cross, declared, facts, flag, items, linked, on, port, reconciles, shown, universe
...
## voci  (portale.html 6025-6141, 117 lines) — §12 · Voci dal Campo
...
## bands  (portale.html 6142-6356, 215 lines) — §7 · The band split
MUST STILL DEFINE (later blocks read these): OD_COLL, OD_DIM, OD_FAM, OD_SCOPE, OD_SRCG, all, c, d, e, head, k, m, odAge, odDay, odDesc, odIndex, odLab, odPair, odSafe, odT, parts, r, rest, themes, x
MAY READ FROM EARLIER BLOCKS: C, EITHER, EMPTY, L, T, a, cl, cropL, cs, csRec, d, daysAgo, declared, decoV, e, evidence, facts, first, flag, g, il, iso, issueL, items, k, keys, kn, l, live, m, match, n, narOf, none, o, on, other, p, parts, proves, r, raw, reconciles, row, rows, s, shown, srcL, t, table, v, verified, voices, was, why, wins, word, x

## casefix  (portale.html 6357-6734, 378 lines) — §7 · MEASURED FAILURE, now fixed
MUST STILL DEFINE (later blocks read these): W, b, body, br, dead, e, kept, none, w
MAY READ FROM EARLIER BLOCKS: CASES, D, K, OD_COLL, OD_DIM, OD_FAM, OD_SCOPE, OD_SRCG, START, T, a, absenceRule, accent, all, c, cl, cs0, csRec, csScen, csUIK, d, declared, e, evidence, facts, first, flag, g, ink, k, keys, l, live, match, n, narOf, nm, none, o, odAge, odDay, odDesc, odIndex, odLab, odPair, odSafe, odT, on, other, out, proves, raw, reconciles, rest, row, rows, s, shown, table, verified, w, was, why, winFor, x, y

## fieldsales+fieldkpi  (portale.html 6735-6892, 158 lines) — §10 · Field Sales is an integration DEMONSTRATION
...
## futuretokens+futurefeed  (portale.html 6893-7268, 376 lines) — §7 · PRESENTATION TOKENS. Authored here
...
MAY READ FROM EARLIER BLOCKS: EMPTY, IT, L, T, TIMING, a, accent, all, allMessages, b, c, cl, cropL, d, declared, demoMessages, e, evidence, facts, fit, fst, g, hasDate, il, iso, issueL, items, k, kept, keys, l, live, m, max, n, note, o, on, oppOf, other, out, p, proves, r, raw, ref, reg, regLine, rest, row, rows, s, shown, srcL, t, tally, tiles, tone, w, was, why, wins, x

## competitorwatch  (portale.html 7269-7413, 145 lines) — §1 · Competitor Watch now reads the model
...
## companies  (portale.html 7414-7491, 78 lines) — §1 · The 14 upstream company rows are 11 companies
...
## density  (portale.html 7492-7514, 23 lines) — §8 · communication density = density inside monitored public communication
...
## idresolve  (portale.html 7515-7598, 84 lines) — §18 · An id that does not resolve must SAY so
...
## science+themejoin  (portale.html 7599-7876, 278 lines) — §12 · This block used to be built on four fixtures
...
MAY READ FROM EARLIER BLOCKS: C, CACTS, CDENS, CEVENTS, CISS, CPRODUCTS, L, N, NODATE, T, TX, a, absenceRule, actsAll, adamaLabel, all, b, cAct, cat, cl, companies, confirmed, cropL, crops, dLabel, e, evDeco, evidence, first, g, head, il, ink, issueL, items, k, l, match, moaNote, n, none, note, o, on, opts, other, paid, pstate, r, raw, related, rows, s, shown, t, table, themes, tok, v, verified, was, why, wins, word, wst, x

## caption88+gire+taxonomy  (portale.html 7877-7964, 88 lines) — §12 · The one caption this screen cannot ship without
