...
"""A MEDIDA DA COMPLETUDE - o que cada oportunidade DEIXOU DE OLHAR.
    ...
    python3 motor/v21_completude_oportunidade.py
...
# Lido de motor/v21_oportunidades.py, nao decorado: a lista esta la em main().
# Ler em vez de copiar e o que impede esta medicao de envelhecer em silencio.
def familias_que_o_motor_carrega():
    src = open(os.path.join(ROOT, 'motor', 'v21_oportunidades.py'),
               encoding='utf-8').read()
...
def main():
    ...
    perda_catalogo = {
        ...
        'CAUSA': ('CROPS_DECLARED_ON_SITE nao vem da ficha do produto: vem de '
                  'CULTURA_PAGINA em fontes/adama_catalogo_montar.py, que so '
