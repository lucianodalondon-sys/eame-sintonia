...
Uso:  python3 portoes/build_portal.py
"""
...
<header class="top">
  ...
  <p>Laboratório das descobertas da MISSÃO EAME 01/02. Não é produto, não é design final.
     Gerado em {built} a partir de <code>data/samples/</code> por <code>portoes/build_portal.py</code>.</p>
</header>
...
<footer>
  ...
  e o caminho da evidência. Nenhum número foi digitado à mão: <code>portoes/build_portal.py</code>
