...
- **Arquitetura revisada.** Bíblia da Intelligence V0.3, secção 36, com 10 leis
  (`INT-LAW-290..299`) e 14 ataques de red team, cada um com a lei que o barra.
...
prioridade** — tem uma direção (`MORE | SAME | LESS | INVESTIGATE | UNKNOWN`). A
ausência é deliberada: um número atravessaria a fronteira e seria obedecido.
