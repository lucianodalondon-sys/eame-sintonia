...
aqui como entrada — a regra da missao e inventariar antes de coletar.
    ...
    ./fontes/adama_it_intelligence.py
...
Entradas:
    ...
    research/.../MOA-SOURCE-{HRAC,IRAC}.json       (./fontes/adama_it_moa.py)
...
def main():
    ...
    # fontes/adama_it_moa.py. Assim o pacote se refaz sem depender de /tmp.
