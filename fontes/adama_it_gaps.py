...
LABEL-MANIFEST.json. Aqui nada e inventado no lugar dele.
    ...
    ./fontes/adama_it_gaps.py

Entradas ja gravadas no pacote:
    MOA-SOURCE-FRAC.json      (./fontes/adama_it_frac.py)
    MOA-SOURCE-HRAC/IRAC.json (./fontes/adama_it_moa.py)
    EU-SOURCE-540-2011.json   (./fontes/adama_it_eu.py)
    ACTIVE-INGREDIENTS.json, PRODUCT-IDENTITY-MAP.json (./fontes/adama_it_intelligence.py)
"""
import json
import os
import re
