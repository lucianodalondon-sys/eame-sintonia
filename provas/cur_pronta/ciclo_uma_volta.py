...
def egresso():
    r = subprocess.run([sys.executable, "superficie/rede.py", "--portao-de-egresso", "IT"], cwd="C:/cur/ciclo",
...
json.dump({"ANTES": antes, "DEPOIS": depois, "GATILHO": m, "WORKER": res},
          open("C:/cur/ciclo-%s-%d.json" % ("rede" if COM_REDE else "offline", N), "w", encoding="utf-8"), ensure_ascii=False, indent=1, default=str)
