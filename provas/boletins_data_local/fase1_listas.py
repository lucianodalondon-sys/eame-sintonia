...
ALVOS = [   # (SOURCE_IDs, pagina) — uma por anfitriao (D61/D62: as 4 rotas novas de boletim)
    (["IT-T2-148"], "https://arsac.calabria.it/category/ultime-notizie/"),
    (["IT-T3-032"], "https://www.regione.molise.it/flex/cm/pages/ServeBLOB.php/L/IT/IDPagina/18077"),
    (["IT-T3-055"], "https://www.regione.vda.it/agricoltura/per_gli_agricoltori/fitosanitario/avvisi/frutticoltura_i.asp"),
    (["IT-T3-058"], "https://www.regione.veneto.it/web/fitosanitario/bollettini-fitosanitari-2026"),
]
...
(OUT / "FASE1.json").write_text(json.dumps({"FASE": "BOLETINS D61/D62 fase 1", "REDE_AUTORIZADA_POR": a.rede_autorizada,
