...
ALVOS = [   # as rotas PDF da JANELA-FORMAS A (D42): a lista de cada uma, para o canario D61/D62
    (["IT-T3-014"], "https://www.protezionedellepiante.it/category/documenti-tecnici-ufficiali/"),
    (["IT-T3-027"], "http://www.ersa.fvg.it/cms/aziende/in-formazione/Bollettini/index.html"),
    (["IT-T3-025"], "http://www.agricoltura.regione.campania.it/difesa/bollettini/bollettini_2026/NA_2026.html"),
]
...
for sids, url in ALVOS:
    ...
    rb = pedir("%s://%s/robots.txt" % (url.split(":")[0], host))
    if rb is None:
...
(OUT / "FASE1-ROTAS-A.json").write_text(json.dumps({"FASE": "BOLETINS D61/D62 fase 1", "REDE_AUTORIZADA_POR": a.rede_autorizada,
