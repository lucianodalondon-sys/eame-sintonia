...
ALVOS = [   # arsacagrometeo.it: onde o texto do boletim ARSAC vive (as paginas de edicao so o anunciam)
    (["IT-T2-148"], "http://www.arsacagrometeo.it/bollettino_cover.php"),
]
...
(OUT / "FASE1-ARSACAGROMETEO.json").write_text(json.dumps({"FASE": "BOLETINS D61/D62 fase 1", "REDE_AUTORIZADA_POR": a.rede_autorizada,
