...
A Itália escreveu `medidas/fato_local.py`: um LEITOR de texto italiano que
...
lugares, uma lei; qualquer um que ande sozinho reprova.
    ...
    python3 medidas/lugar_do_fato.py     # imprime o contrato
"""
import json
import sys
...
def contrato():
    return {
        ...
        'O_QUE_ISTO_NAO_E':
            ...
            'em medidas/fato_local.py, portado da branch da Itália.',
        ...
        'LEITORES_POR_IDIOMA': {'it': 'medidas/fato_local.py (portado da Itália)'},
    }
