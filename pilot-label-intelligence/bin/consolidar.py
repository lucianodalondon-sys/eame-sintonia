...
def main():
    ...
    if os.path.exists(a.versoes):
        ...
        versoes = {
            ...
            "FIELD_DIFFS_WITHOUT_NORMALISATION": v.get("FIELD_DIFFS_WITHOUT_NORMALISATION"),
            "FIELD_DIFFS_WITH_NORMALISATION": v.get("FIELD_DIFFS_WITH_NORMALISATION"),
            "SERIALIZATION_NOISE_SUPPRESSED": v.get("SERIALIZATION_NOISE_SUPPRESSED"),
            "NOISE_SHARE": v.get("NOISE_SHARE"),
        }
