...
CAMADA EU ACTIVE SUBSTANCE × PORTFÓLIO ADAMA ITÁLIA — a camada que faltava.
    ...
    bash coleta/cellar.sh substances 2024 > .tmp/eu-2024.json   (e 2025, 2026)
    python3 coleta/eu_substancia_adama_it.py
...
def main():
    ...
    corpo = {
        ...
        'reproduce': 'bash coleta/cellar.sh substances <ano>',
