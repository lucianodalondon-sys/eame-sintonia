...
DADO PESSOAL DO INSTAGRAM — dono único do que se pode e do que não se pode guardar.
    ...
    py coleta/instagram_pessoal.py estado        # o portão está aberto? por quê?
    py coleta/instagram_pessoal.py expurgar      # apaga o acervo de comentário, inteiro
...
def estado():
    ...
    return {
        ...
        'PURGE_READY': True,
        'PURGE_HOW': 'py coleta/instagram_pessoal.py expurgar',
    }
