...
VALE A PENA ESTA FONTE? — a peneira que roda ANTES do whisper, e custa zero.
    ...
    py coleta/youtube_relevancia.py fontes    # o canal fala a língua do projeto?
    py coleta/youtube_relevancia.py fila      # quem vai ao whisper, e por quê
    py coleta/youtube_relevancia.py teste     # as provas, sem rede
    py coleta/youtube_relevancia.py tudo
...
def fase_fontes():
    ...
    p = _gravar('FONTES.json', {
        ...
        'DE_ONDE_VEM_O_LEXICO': ('regras/sensor_medir.py, lido em tempo de execução. '
