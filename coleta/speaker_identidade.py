...
IDENTIDADE DO SPEAKER — o portão que roda ANTES de qualquer execução paga.
    ...
    python3 coleta/speaker_identidade.py montar
    python3 coleta/speaker_identidade.py resumo
...
def _fila_es_olive():
    ...
    for p in d['QUEUE']:
        ...
        fora.append({
            ...
            'ORIGIN': 'RESEARCHER-PUBLIC-VOICE-QUEUE-ES (derivada por coleta/filas.py)',
        })
    return fora
