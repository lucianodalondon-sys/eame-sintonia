...
import autorizacao_de_gasto as _az  # noqa: E402  — so o TIPO da recusa
...
#: e nao pergunta se uma fonte serve.
#:
#:     SALDO ESGOTADO != NINGUEM AUTORIZOU.
SemAutorizacaoDeGasto = _az.SemAutorizacaoDeGasto
...
def _executar(*, platform, capability, run_id, country_scope='IT',
    ...
    except (SemOrcamentoDeRede, SemOrcamentoFinanceiro, SemAutorizacaoDeGasto):
        # As recusas dos TRES PORTOES sobem inteiras ate ao executor, que e quem
        # sabe qual era cada um. Traduzi-las aqui para um estado de rota faria
        # a casa dizer que a fonte recusou quando fomos nos.
        #
        # ⚠️ A TERCEIRA ENTROU NA SCRAP-CV-02, e por medicao: sem ela,
        # `SemAutorizacaoDeGasto` caia no balde generico deste ficheiro e subia
        # como `UNKNOWN_ERROR` — o balde de «ninguem sabe o que houve» para uma
        # recusa que sabe exactamente o que houve.
        #
