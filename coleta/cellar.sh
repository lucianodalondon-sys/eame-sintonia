...
#
#   ./coleta/cellar.sh sparql "<query SPARQL>"        -> resultados JSON
#   ./coleta/cellar.sh act <CELEX> <iso3>             -> texto integral XHTML
#   ./coleta/cellar.sh substances <ano>               -> atos do ano sobre active substance
#
