...
CORPUS DO PESQUISADOR — o que as 12 identidades PROVADAS publicam, explicam e apresentam.
    ...
    python3 coleta/corpus_pesquisador.py coletar   # busca e guarda o cru (rota gratuita)
    python3 coleta/corpus_pesquisador.py medir     # classifica, dedupe, mede, publica
    python3 coleta/corpus_pesquisador.py resumo    # relê o publicado e imprime o quadro
