...
Uso:
    python3 coleta/pdf_text.py arquivo.pdf            # texto, uma linha por Tj/TJ
    python3 coleta/pdf_text.py arquivo.pdf --pages    # separa por página

O que ele NÃO faz: layout, colunas, tabelas. Quem precisa de coluna tem de
declarar a regra de corte — ver `coleta/denominaciones.py`.
"""
import re
import sys
import zlib
