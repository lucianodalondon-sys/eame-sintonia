...
USO
    python3 coleta/mapa_regfi.py producto ES-01717
    python3 coleta/mapa_regfi.py export  > ropf.json      # registro inteiro
    python3 coleta/mapa_regfi.py total   Titular=ADAMA
"""
import json
import re
import sys
