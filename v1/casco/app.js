...
function viewHome() {
  ...
  <div class="block">
    ...
    <div class="meta"><b>${P.history.snapshots}</b> instantaneos oficiais baixados, dos quais
      ...
      <b>Sem esse filtro seriam ${P.history.raw_field_diffs} alertas para encontrar
      ${P.history.true_changes}.</b></div>
  ...
  <div class="block">
    ...
    ${relev.length ? `<div class="tw" style="margin-top:8px"><table>
      ...
      <tbody>${relev.slice(0,12).map(({o,r}) => `<tr>
        ...
        <td>${valorDemo(o)} &rarr; ${o.OBJECT_TYPE==='NEEDS_HUMAN_REVIEW'?RETIDO_TXT:val(o.AFTER_VALUE)}</td>
...
function viewProduto(reg) {
  ...
  <div class="block" style="border-left:3px solid var(--warn)">
    ...
    <div class="lei">${(p.states && p.states.LABEL_DOWNLOADED === false)
      ? `<b>Nao ha documento para ler.</b> Nenhum rotulo foi baixado para este registro
         ...
         reter: nao e recusa, e ausencia de coleta.`
      : `<b>O sistema leu esta informacao e esta se recusando a publica-la.</b>
         Nao e falta de dado: sao ${(p.uses||[]).length} pares cultura &times; alvo e
         ${(p.doses||[]).length} linhas de dose que o leitor extraiu deste documento.`}
      ...
      a tabela tem <b>fios desenhados</b> separando blocos de cultura — ha caso medido em que a
      linha atribuida a uma cultura pertence, na tabela real, ao bloco da cultura de cima, do
      outro lado de um fio. Enquanto uma terceira rodada adversarial independente nao adjudicar
      essa camada, <b>nenhum par cultura &times; alvo e nenhuma dose sao apresentados como
      fato</b> nesta demonstracao.</div>
      ...
      <b>Esconder uma funcao e melhor do que demonstrar uma informacao regulatoria errada.</b></div>
      <div class="meta" style="margin-top:6px">Estado: <span class="unknown">NEEDS_REVIEW</span>
      &middot; adjudicacao em curso &middot; o que a ferramenta ja consegue provar sobre este
      produto esta acima, e volta a fonte oficial.</div></div>
  </div>
  ...
  return `<div class="tw"><table>
    ...
    <tbody>${lista.map(o => `<tr>
      ...
      <td colspan="2" class="meta"><span class="unknown">WITHHELD_PENDING_ADJUDICATION</span>
        <div class="meta">a cultura, o alvo e o valor lidos existem e estao no dossie tecnico.
        Nesta demonstracao nao sao exibidos: e a camada que a terceira rodada adversarial ainda
        julga, e mostrar o triplo aqui daria a ele a aparencia de fato.</div></td>
    ...
    <div class="tw"><table><tbody>${Object.entries(c).map(([k,o]) =>
      k === 'PHI_COVERAGE'
        ? `<tr><td>${k.replace(/_/g,' ')}</td>
           <td><span class="unknown">NOT_ATTEMPTED</span></td>
           <td class="meta">o extrator de carencia esta marcado <code>PROTOTYPE_NOT_SHIPPED</code> e
             <b>nunca rodou</b> nos ${o.OF} rotulos. Desenhar isto como &ldquo;0 de ${o.OF}, 0%&rdquo;
             na mesma escala das coberturas medidas seria publicar nao-tentativa como medicao.</td></tr>`
...
function viewSearch() {
  ...
  const objs = P.objects.filter(o =>
    [o.PRODUCT_NAME,o.REGISTRATION_ID,o.CHANGE_TYPE,o.BEFORE_VALUE,o.AFTER_VALUE]
