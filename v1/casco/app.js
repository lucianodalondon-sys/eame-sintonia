...
const PAR_ROTULO = {
  ...
  // A FRASE DIZIA MAIS DO QUE A REGRA TESTOU. R-14 nao olha "a pagina" do par —
  // 1.427 pares nem preservaram PAGE — ele varre TODAS as paginas e so cai aqui
  // quando o nome da cultura e o do alvo NUNCA aparecem na MESMA pagina. Dizer
  // "o nome deste alvo nao ocorre na pagina" e uma afirmacao sobre o documento
  // que a regra nao fez: em muitos destes o alvo ocorre, e o que falta e a
  // coincidencia com a cultura. Medido pela lente L: falso em 80 dos 256.
  PAIR_NOT_CHECKABLE_ANCHOR_NOT_FOUND: ['p-unk', 'TABELA · CULTURA E ALVO NUNCA NA MESMA PAGINA',
    'em nenhuma pagina do PDF o nome desta cultura e um glifo deste alvo aparecem juntos — o alvo pode estar escrito noutra pagina, ou com outro nome (o rotulo costuma usar o binomio latino). Nao ha celula a testar, e isto NAO diz que o alvo nao esta no documento'],
