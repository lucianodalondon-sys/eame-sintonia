...
function viewHome() {
  ...
  <div class="block">
    ...
    <div class="meta"><b>${P.history.raw_field_diffs}</b> diferencas brutas entre os
      ${P.history.snapshots} instantaneos oficiais &rarr; <b>${P.history.noise}</b>
      (${P.history.noise_pct}%) eram a fonte reordenando a propria lista, e nao viram evento
      &rarr; restam <b style="color:var(--ok)">${P.history.true_changes}</b> mudancas reais.
  ...
  <div class="block">
    ...
    ${relev.length ? `<div class="tw" style="margin-top:8px"><table>
      <thead><tr><th>Produto</th><th>O que mudou</th><th>Antes &rarr; Depois</th><th>Estado</th>
        <th>Regra</th><th></th></tr></thead>
  ...
  <div class="block">
    ...
    <div class="lei">Isto e funcionalidade, nao defeito. <b>${rev.length}</b> doses foram
      ...
      rotulos tiveram a tabela de uso nao lida. Nenhum deles vira numero na tela.
...
function viewProduto(reg) {
  ...
  <div class="block" style="border-left:3px solid var(--warn)">
    ...
    <div class="lei"><b>O sistema leu esta informacao e esta se recusando a publica-la.</b>
