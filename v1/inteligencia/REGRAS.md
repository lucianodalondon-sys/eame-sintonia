...
| `R-13` | `TARGET_TEXT_LITERAL_CHECK` — o texto do alvo de uma linha de dose e procurado literalmente no texto do rotulo. Quem nao aparece sai como `TARGET_TEXT_NOT_FOUND_LITERALLY`. **Nenhuma linha e rebaixada por esta regra** | existe fusao de linha provada: em `008259` o alvo &ldquo;Nottue defogliatrici (allo scoperto) tentredine&rdquo; junta a cauda de uma linha com o texto de outra e recebe a dose da errada (800 contra 500 autorizados). Mas nao ha detector de fusao aqui, e a regra diz isso: o teste literal acusa 180 das 839 linhas e a maioria e alvo quebrado entre colunas; a heuristica de conteudo acusa 86 e condena alvo multiplo legitimo (`Pomacee x Dysaphis spp., Eriosoma spp., Aphis spp.`); e a ancoragem por fios nas duas pontas do alvo acusa **zero**, porque a banda do extrator nao contem as duas pontas do alvo fundido. Rebaixar por um teste que nao separa os dois casos apagaria uso verdadeiro; calar esconderia a fusao provada. O estado e a resposta honesta entre as duas |
