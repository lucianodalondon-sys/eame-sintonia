...
MUTANTES = [
    ...
    ("M28_DIA_CALCULADO_VIRA_DIA_SOLTO", "D69: reprova se o dia calculado voltar a escrever-se como o dia solto "
     "(«oggi, lunedì» com publicacao so-dia fica igual a PUBLISHED_AT e a lei reprova)",
    ...
    ("M30_EVIDENCIA_DA_CONTA_PERDIDA", "DA-7/D69: reprova se a expressao e o trecho da conta se perderem",
