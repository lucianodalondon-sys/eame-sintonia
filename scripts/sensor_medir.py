...
if __name__ == '__main__':
    ...
    corpo = {
        ...
        # ⚠️ A REGUA DE EVIDENCIA DESTA CASA EXIGE `captured_at`, E ESTE ARQUIVO
        # PAROU DE ESCREVE-LO. Medido em 2026-09-03: a versao de 30/08 declarava
        # captured_at='2026-08-30'; a de 02/09, que traz 1071 videos no lugar de
        # 431, nao declara nada — e `tests/test_evidence.py` reprova por isso.
        #
        # O conserto e AQUI e nao no JSON: o artefato e DERIVADO, e sera reescrito
        # na proxima medicao. Consertar o dado deixaria o gerador produzindo o
        # defeito de novo, calado, na primeira vez que alguem rodasse a medicao.
        #
        #     ARTEFATO DERIVADO SE CONSERTA NO GERADOR, NUNCA NO ARQUIVO.
