# -*- coding: utf-8 -*-
"""CAPA-MATERIA · mutacao do filtro de pagina institucional, numa COPIA.

    py scripts/capa_materia/mutar_filtro.py <caminho-da-copia>
...
out = {"DATASET": "MUTACAO-FILTRO-INSTITUCIONAL-V1", "COPIA": R, "MUTANTES": res,
       "MORTOS": sum(1 for v in res.values() if v["RESULTADO"] == "MORTO"), "TOTAL": len(res)}
open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "MUTACAO-FILTRO-INSTITUCIONAL-V1.json"), "w",
