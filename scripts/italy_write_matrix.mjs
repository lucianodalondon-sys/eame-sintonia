...
P("# MATRIZ DE CONTRATOS DE FONTE — ITÁLIA V1", "",
  ...
  "Contratos em `scripts/italy_contracts.mjs`. Medidor em `scripts/italy_source_health.mjs`.", "",
  "Este arquivo é **gerado** por `scripts/italy_write_matrix.mjs`. Não editar à mão.", "",
...
P("", "---", "", "## SE NÃO COLETARMOS HOJE, O QUE DESAPARECE?", "",
  ...
  "", "---", "", "## Controles negativos", "",
  "Um teste que nunca viu vermelho não é teste. `node scripts/italy_source_health.mjs --negativos`",
