...
arquivo scripts/fato_local.py. Nenhuma linha foi reescrita.
...
A LEI que ele exerce, essa é do core, e mora em scripts/lugar_do_fato.py:
...
tem um leitor por idioma sem ter duas leis para a mesma pergunta.
