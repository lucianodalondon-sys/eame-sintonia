...
def main():
    ...
    for r in porta:
        ...
        fora.append({
            ...
            # ⚠️ A PERGUNTA QUE 85df96f OBRIGA A FAZER. Aquele commit ingeriu
            # disciplinari regionais como STANDING_RULE, pela MESMA porta. Se um
            # destes 16 disser a mesma coisa que uma regra já ingerida, ele
            # deixou de ser lacuna e passou a ser duplicata.
