...
class OPacoteNaoInfluenciaORevisor(unittest.TestCase):
    ...
    def test_o_protocolo_nao_virou_lei(self):
        ...
        # italianos reais recebiam `NAO_SE_APLICA` por ela nao existir. E `T7`
        # perdeu `soci`, que casava dentro de «sociale», «social» e
        # «association» e NUNCA em «soci». As duas medicoes vivem em
