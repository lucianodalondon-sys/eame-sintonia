...
# Foi ela que produziu os 23 RAW que acabaram VERSIONADOS em
# `data/samples/SOCIAL-IT/raw-free/` — e foi esse acervo que fez uma corrida
# sem coleta parecer ter colhido (corrida 34257202987). O inventario ja foi
# consertado do outro lado; aqui se conserta a ORIGEM.
#
#     CHECKOUT NAO E COLETA — e teste nenhum devia ter criado esse checkout.
_env.RAW_DIR = os.path.join(tempfile.gettempdir(), 'sintonia-raw-yt-oficial')
