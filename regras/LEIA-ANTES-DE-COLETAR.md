...
| | |
|---|---|
| estado | PENDING — o sistema importa esta lei em runtime para decidir: C-CURATOR-CLASSIFICACAO-INDICE, C-CURATOR-ESTADO-ACTUAL, C-CURATOR-LIFECYCLE, C-IT-CATALOGO.  Mas 4 ficheiro(s) mudaram depois de a descricao ter sido conferida — precisa de releitura humana. |
