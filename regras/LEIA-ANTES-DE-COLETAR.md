...
- **Micro-verificacao D74 — escolha por regra, previsao e SELECTs so-leitura** — Plano de UMA micro (nao onda) para provar que a coleta real com o codigo instalado e5cd691f faz chegar a Sala itens novos com publicacao/lugar/data e bases: regra de escolha escrita antes (5 fontes, 5 dominios, 16 pedidos), alvos novos D40 medidos nos indices guardados, data-na-pagina medida no armazem, previsao com os leitores instalados, comando exato e SELECTs read-only (Q0-Q5) conferidos num Postgres descartavel com as 33 migracoes.
