...
//
// Uso:  node regras/italy_source_health.mjs [--negativos]
...
function texto(caminho, tipo) {
  ...
  if (tipo === "ZIP") { try { return execFileSync("node", ["ferramentas/ods_peek.mjs", caminho, "4000"], { encoding: "utf8" }); } catch { return ""; } }
