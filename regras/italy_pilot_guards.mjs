...
export function guardasDoPiloto(T) {
  ...
  T("os contratos carregam a lei SAME_HASH != DEGRADED",
    /SAME_HASH\s*!=\s*DEGRADED/.test(readFileSync("regras/italy_contracts.mjs", "utf8")));
  ...
  const arquivos = ["coleta/italy_pilot_collect.mjs", "provas/italy_pilot_negativos.mjs"].map(f => readFileSync(f, "utf8")).join("");
