...
class OCanarioPerguntaAoMotor(unittest.TestCase):
    ...
    def test_boletim_com_data_passa_e_a_regua_e_a_irma(self):
        ...
        self.assertIn(g["REGUA"], RS.REGUAS_QUE_ADMITEM)
...
class ARegua(unittest.TestCase):
    ...
    def test_as_formas_nao_se_misturam(self):
        ...
        self.assertNotIn(regua(_contrato(), prova_bol)["REGUA"], RS.REGUAS_QUE_ADMITEM)
...
class OPortaoEORobo(unittest.TestCase):
    ...
    def test_o_portao_aceita_a_regua_irma_e_continua_a_recusar_legacy(self):
        self.assertIn(RS.REGUA_PAGINA_BOLETIM, RS.REGUAS_QUE_ADMITEM)
        self.assertIn(RS.REGUA_CURRENT, RS.REGUAS_QUE_ADMITEM)
        self.assertNotIn(RS.REGUA_LEGACY, RS.REGUAS_QUE_ADMITEM)
        self.assertNotIn("NAO SEI", RS.REGUAS_QUE_ADMITEM)
        self.assertIn(RS.REGUA_SOCIAL, RS.REGUAS_QUE_ADMITEM)   # BOLETINS-V2: a lista unica tem as tres
