...
class _Base(unittest.TestCase):
    def setUp(self):
        self.tmp = Path(self.enterContext(tempfile.TemporaryDirectory(prefix="decisao-sem-")))
        ...
        self.addCleanup(setattr, W, "PULSO", W.PULSO)  # o pulso do worker e prova de vida: nunca o real
