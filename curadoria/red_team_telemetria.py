...
MUTANTES = [
    ("M1_READY_IGUAL_DISCOVERED",
     ...
     "telemetria.py", "if ns == READY:", "if ns == READY or ns == LC.CONTRACT_PENDING:",
    ...
    ("M3_READY_INCREMENTA_2X",
     ...
     "telemetria.py", 'm["READY_CURRENT"] += 1', 'm["READY_CURRENT"] += 2',
    ...
    ("M4_EVENTO_ANTIGO_NA_JANELA_1H",
     ...
     "telemetria.py", "if at is None or not (desde <= at < ate):", "if at is None:",
    ...
    ("M5_RESTART_ZERA_24H",
     ...
     "telemetria.py", "j24 = _janela(tr, n - timedelta(hours=24), n)",
    ...
    ("M6_BLOQUEIO_CONTA_COMO_READY",
     ...
     "telemetria.py", 'm["CAPABILITY_BLOCK"] += 1', 'm["READY_CURRENT"] += 1',
    ...
    ("M7_SEM_PROGRESSO_PARECE_NORMAL",
     ...
     "telemetria.py", 'return "ACTIVE_NO_OUTPUT"', 'return "ACTIVE_PRODUCTIVE"',
