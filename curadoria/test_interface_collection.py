#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""ATAQUES AO CONTRATO CURATOR <-> COLLECTION.

O contrato tem duas frases. Estes testes tentam fazer cada uma mentir.
Correm sobre ficheiros proprios: nunca escrevem no livro da casa.
"""
...
class Isolada(unittest.TestCase):
    def setUp(self):
        ...
        F.FILA = d / "QUEUE.json"
        IC.LC, IC.F = LC, F
        # A ficha do contrato vem do registo ACTUAL da Collection, nunca da fotografia.
        IC.ESTADO_ACTUAL = RAIZ / "curadoria" / "ESTADO-ACTUAL-DAS-FONTES-V1.json"
