...
def _linhas_de_comando(t: str, arv=None) -> str:
    ...
    ⚠️ ESTA CORRECCAO JA FOI APAGADA UMA VEZ, EM SILENCIO: 867f2f1d trouxe o
    mecanismo do observador de outra linha e, com ele, a versao anterior a
    C10.4C deste ficheiro. `tests/test_c10_4c_rota_aposentada.py::test_14`
    ficou vermelho desde entao. Reposta (vermelhos herdados, 2026-09-25).
