...
CONTRATO DO ATOR — o portão grátis do gasto. Roda antes de toda fase paga, sem exceção.
    ...
    py ferramentas/contrato_ator.py apify~instagram-scraper
    py ferramentas/contrato_ator.py --missao instagram        # o conjunto da Missão 14
...
---------------------------------------------
`coleta/comunicacao_coleta.py` desistia com `POOL_EMPTY` quando não havia chave — e assim
