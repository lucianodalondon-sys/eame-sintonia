#!/usr/bin/env python3
"""(copia de acervo-tempo-lugar-v1:scripts/reproc_acervo/prever_acervo.py, para o LEITOR-DATA-YOUTUBE medir antes/depois;
so muda o campo CODIGO, que passa a dizer a arvore que correu)
...
def main():
    ...
    out["CODIGO"] = "arvore %s (italy_executor.tempo_e_lugar + orquestrador._fato_do_texto)" % __import__("subprocess").run(
