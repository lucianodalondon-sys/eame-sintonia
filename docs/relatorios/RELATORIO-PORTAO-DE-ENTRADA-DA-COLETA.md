...
| Testes Python | **<!--M:TEST_COUNT_CURRENT-->2.701<!--/M-->**, todos verdes |
| Testes Python | **<!--M:TEST_COUNT_CURRENT-->2.888<!--/M-->**, todos verdes |
| Apify gasto | **0,00 USD** |

## B · REUSO, NÃO SEGUNDA IMPLEMENTAÇÃO

`ferramentas/apify_pool.py`, `apify_contrato.py` e `apify_recuperar.py` vieram **portados
...
acrescentou é uma camada **acima** deles — `coleta/coleta_checkpoint.py` —, e é por isso
