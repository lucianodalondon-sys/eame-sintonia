...
`SPAIN-DEMO-CONTENT-V1` agora carrega sha256, tamanho e último commit de cada um dos 13 artefatos canônicos, mais o HEAD que os sustenta. `provas/es/freeze_es.py` confere e sai com código 1 se qualquer um divergir.
...
`superficie/es/proto_es.py` gera a tela inteira do pacote congelado. **Nenhum texto de caso foi escrito na interface.**
