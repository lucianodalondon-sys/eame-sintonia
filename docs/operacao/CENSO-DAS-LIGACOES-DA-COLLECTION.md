...
```
HEAD_DA_MEDICAO  ce40e387dbd6d51061d6a8b41105a200623bbf6c
BRANCH           contrato-unico-v1
GERADO_EM        2026-09-23T03:26:58-03:00
CARDS            89
...
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | scripts/desbloqueio/aplicar_desbloqueio.py:230; scripts/micro_coleta/micro_coleta.py:120; tests/test_micro_coleta_instrumento.py:171 |
...
| **status operacional** | yellow — existe, mas nada no repositorio manda rodar nem importa — pode estar desligado. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | scripts/desbloqueio/aplicar_desbloqueio.py:208; tests/test_aplicar_desbloqueio.py:33 |
