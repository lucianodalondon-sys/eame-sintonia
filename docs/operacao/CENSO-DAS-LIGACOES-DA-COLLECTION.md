...
```
HEAD_DA_MEDICAO  bfd625cc1fda550bbbac9a73a7e84abc59c76f70
BRANCH           runbook-micro-social-v1
GERADO_EM        2026-09-26T03:47:23-03:00
CARDS            105
...
| **prova de quem ativa** | pedido/receitas.py:105; orquestrador/orquestrador.py:993 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
...
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
| **prova das ligações** | CODE 20 · OBSERVED 2 |
| **lei da Bíblia** | COL-LAW-006/007 · RAW primeiro, e RAW nao e derivado |
...
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 7 · saem 7 |
...
| **QUEM ATIVA** | **PECA_INTERNA** — C-ORQUESTRADOR |
| **prova de quem ativa** | pedido/receitas.py:122; orquestrador/orquestrador.py:993 _(plano OBSERVED)_ |
| **porquê** | uma corrida medida chamou esta peca — e nao so uma linha que diz que podia chamar. |
| **o que entra · dado** | V-HTTP |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **data plane** | entram 1 · saem 0 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
| **prova das ligações** | CODE 5 · OBSERVED 1 · NÃO SEI 1 |
| **lei da Bíblia** | COL-LAW-006/007 · RAW primeiro, e RAW nao e derivado |
| **VEREDITO** | **OK** — travessia OBSERVADA numa corrida real |
...
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | coleta/italy_executor.py:243; medidas/medir_v1a.py:45; medidas/mutacao_v1a.py:19 |
| **porquê** | estas pecas importam-na — C-DETECTOR-CAPA-GABARITO · C-IT-COLETA — e IMPORTAR NAO E MANDAR CORRER. O mapa nao mede quem lhe da a ordem, e por isso nao a inventa. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | `curadoria/retrato_html.py` |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 5 · saem 7 |
| **arestas provadas** | entram 5 · saem 7 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
| **data plane** | entram 0 · saem 0 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
...
| **arestas no mapa** | entram 5 · saem 20 |
| **arestas provadas** | entram 4 · saem 19 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
...
| **QUEM ATIVA** | **PECA_INTERNA** — C-ORQUESTRADOR |
| **prova de quem ativa** | pedido/receitas.py:236; orquestrador/orquestrador.py:993 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | V-HTTP |
...
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | admissao/reprocessar_tempo_lugar.py:56; coleta/derivacao_forward.py:347; coleta/golden_path_pdf.py:51 |
...
| | |
|---|---|
| **peça real** | `coleta/italy_executor.py`, `coleta/italy_find_docs.mjs`, `coleta/italy_pilot_collect.mjs`, `coleta/italy_probe.mjs`, `coleta/italy_recurrent_collect.mjs` _(e mais 1)_ |
| **papel** | MEASUREMENT_INSTRUMENT · medido no plano CODE |
| **dono** | INTELIGENCIA · TECNICO_CIENCIA |
...
| **QUEM ATIVA** | **PECA_INTERNA** — C-ORQUESTRADOR |
| **prova de quem ativa** | pedido/receitas.py:170; orquestrador/orquestrador.py:993 _(plano OBSERVED)_ |
| **porquê** | uma corrida medida chamou esta peca — e nao so uma linha que diz que podia chamar. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 14 · saem 25 |
| **arestas provadas** | entram 11 · saem 24 |
| **OBSERVADAS** | 1 — corrida `?` |
| **control plane** | entram 1 · saem 0 |
| **data plane** | entram 0 · saem 0 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
| **prova das ligações** | CODE 34 · NÃO SEI 4 · OBSERVED 1 |
| **lei da Bíblia** | COL-LAW-006/007 · RAW primeiro, e RAW nao e derivado |
| **VEREDITO** | **OK** — travessia OBSERVADA numa corrida real |
...
| **status operacional** | yellow — outra peca do sistema importa isto para funcionar.  Mas ha 1 ficheiro(s) novos que nunca foram lidos por gente. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | orquestrador/orquestrador.py:706; provas/a_linhagem_do_ready.py:60; provas/a_ponte_de_midia_no_postgres.py:67 |
...
| **status operacional** | green — outra peca do sistema importa isto para funcionar. |
| **QUEM ATIVA** | **PECA_INTERNA** — C-ORQUESTRADOR |
| **prova de quem ativa** | pedido/receitas.py:157; orquestrador/orquestrador.py:993 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | V-HTTP |
...
| **status operacional** | yellow — outra peca do sistema importa isto para funcionar.  Mas ha 1 ficheiro(s) novos que nunca foram lidos por gente. |
| **QUEM ATIVA** | **PECA_INTERNA** — C-ORQUESTRADOR |
| **prova de quem ativa** | pedido/receitas.py:410; orquestrador/orquestrador.py:993 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | C-MICRO-SOCIAL |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 6 · saem 18 |
| **arestas provadas** | entram 6 · saem 18 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 1 · saem 0 |
| **data plane** | entram 0 · saem 1 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
...
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 9 · saem 47 |
| **arestas provadas** | entram 7 · saem 46 |
| **OBSERVADAS** | 2 — corrida `RUN-M2-E2E` |
| **control plane** | entram 1 · saem 0 |
| **data plane** | entram 3 · saem 1 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
| **prova das ligações** | CODE 51 · NÃO SEI 3 · OBSERVED 2 |
...
| **arestas provadas** | entram 5 · saem 8 |
| **OBSERVADAS** | 0 |
...
### `C-BIG-COLLECTION-CONDUTOR-BC5` · Condutor da Big Collection (1.a onda, BC5)

| | |
|---|---|
| **peça real** | `ferramentas/big_collection/bc5_big_collection.py` |
| **papel** | MEASUREMENT_INSTRUMENT · medido no plano CODE |
| **dono** | ENGENHARIA |
...
| | |
|---|---|
| **peça real** | `ferramentas/cutover/congelar_extras.py`, `ferramentas/cutover/medir_cutover.py`, `ferramentas/cutover/observador_ensaio.py`, `ferramentas/cutover/passos_do_cutover.py`, `ferramentas/cutover/resolver_conflitos_ensaio.py` _(e mais 10)_ |
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | ENGENHARIA |
...
| **prova de quem ativa** | ferramentas/integra_onda2/final/ensaio_integra.sh:40; ferramentas/onda3_pacote/ensaio_onda3.sh:111; ferramentas/onda3_pacote/ensaio_onda3_v2.sh:155 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 6 · saem 0 |
| **arestas provadas** | entram 6 · saem 0 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 2 · saem 0 |
| **data plane** | entram 0 · saem 0 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
...
### `C-HR6` · HR-6 — re-medir pelo caminho canonico as READY que o portao manda a olho humano

| | |
|---|---|
| **peça real** | `ferramentas/hr6/hr6-copia.sh`, `ferramentas/hr6/hr6-plano.sh`, `ferramentas/hr6/remedir_hr6.py`, `ferramentas/hr6/ronda_a_reparo_infere.py`, `ferramentas/hr6/ronda_bc_canario_curador.py` _(e mais 2)_ |
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | ENGENHARIA |
...
| **QUEM ATIVA** | **PECA_INTERNA** — C-PACOTE-ONDA3 |
| **prova de quem ativa** | ferramentas/onda3_pacote/ensaio_onda3.sh:103; ferramentas/onda3_pacote/ensaio_onda3_v2.sh:108 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
### `C-INTEGRA-ONDA2` · INTEGRA-ONDA2 — o ensaio integrado da 2.a onda e a prova do teto sobre o plano do MICRO

| | |
|---|---|
| **peça real** | `ferramentas/integra_onda2/final/ensaio_integra.sh`, `ferramentas/integra_onda2/prova_teto_micro.py` |
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | ENGENHARIA |
...
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | ferramentas/onda3_pacote/ensaio_onda3.sh:77; medidas/canario_rotas_elegiveis.py:48; scripts/desbloqueio/aplicar_desbloqueio.py:243 |
| **porquê** | estas pecas importam-na — C-CANARIO-ROTAS-ELEGIVEIS · C-DESBLOQUEIO-PACOTE · C-MICRO-COLETA-INSTRUMENTO · C-PACOTE-ONDA3 — e IMPORTAR NAO E MANDAR CORRER. O mapa nao mede quem lhe da a ordem, e por isso nao a inventa. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
### `C-LEGACY-99` · LEGACY-99: as READY_LEGACY de volta pela regua de hoje (ensaios e mutacao)
...
### `C-MICRO-SOCIAL` · Condutor da MICRO SOCIAL (LinkedIn + YouTube) — rodadas com travas, previsao do teto antes e prova-teto da noite depois

| | |
|---|---|
| **peça real** | `ferramentas/micro_social/RUNBOOK-MICRO-SOCIAL.md`, `ferramentas/micro_social/_mutantes_micro_social.py`, `ferramentas/micro_social/ensaio/LOTE-DO-ENSAIO.json`, `ferramentas/micro_social/ensaio/SHA256SUMS.txt`, `ferramentas/micro_social/ensaio/integra-noite/LOTE-DO-ENSAIO.json` _(e mais 6)_ |
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | ENGENHARIA |
| **status operacional** | yellow — outras pecas importam ou carregam isto.  Mas ha 11 ficheiro(s) novos que nunca foram lidos por gente. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | — NÃO SEI |
| **porquê** | nenhuma peca do mapa a manda correr com prova, e ela nao e botao, nem produtor externo declarado, nem contrato, nem canal. UNKNOWN nao e NAO: pode haver quem a chame por um caminho que o mapa ainda nao mede. |
| **o que entra · dado** | C-ASK-SINTONIA, C-IT-PRESERVAR, C-SCRAP-COLHEITA, C-SCRAP-SOCIAL, C-TRANSCRICAO |
| **o que entra · ficheiros** | `coleta/scrap_colheita.py`, `coleta/scrap_http.py`, `data/collection-ledger/italy/runs.ndjson` |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
...
| | |
|---|---|
| **peça real** | `ferramentas/onda3_pacote/ensaio_onda3.sh`, `ferramentas/onda3_pacote/ensaio_onda3_v2.sh`, `ferramentas/onda3_pacote/medida-bc/ensaio_bc.sh`, `ferramentas/onda3_pacote/v2/tl-testes.sh` |
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | ENGENHARIA |
...
| **porquê** | nenhuma peca do mapa a manda correr com prova, e ela nao e botao, nem produtor externo declarado, nem contrato, nem canal. UNKNOWN nao e NAO: pode haver quem a chame por um caminho que o mapa ainda nao mede. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | `curadoria/DECISAO-D52-RETIRAR-V1.json`, `curadoria/ROTAS-ELEGIVEIS-V1.json`, `curadoria/italy_contracts_curator.json` |
| **o que sai · dado** | C-INTEGRA-ONDA2 |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 4 · saem 9 |
| **arestas provadas** | entram 4 · saem 9 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 7 |
| **data plane** | entram 0 · saem 1 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
...
### `C-PONTE-ONBOARD` · A impressao digital do contrato que o robo vai usar (PONTE-ONBOARD)

| | |
|---|---|
| **peça real** | `curadoria/sha_do_contrato.py`, `ferramentas/ponte_onboard/mutacao.py` |
| **papel** | MEASUREMENT_INSTRUMENT · medido no plano CODE |
| **dono** | ENGENHARIA |
| **status operacional** | yellow — outras pecas importam ou carregam isto.  Mas ha 2 ficheiro(s) novos que nunca foram lidos por gente. |
| **QUEM ATIVA** | **NAO_SEI** |
...
| **o que sai · dado** | C-EXECUTOR-TRANSCRICAO-MIDIA, C-MICRO-SOCIAL, C-SCRAP-SOCIAL |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 4 · saem 19 |
| **arestas provadas** | entram 4 · saem 19 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 1 · saem 0 |
| **data plane** | entram 0 · saem 3 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
...
| **status operacional** | yellow — importa coisas, mas ninguem o chama — portao fora do caminho nao guarda nada. |
...
| **status operacional** | yellow — existe teste que exercita isto.  Mas ha 1 ficheiro(s) novos que nunca foram lidos por gente. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | orquestrador/orquestrador.py:519 |
| **porquê** | estas pecas importam-na — C-ORQUESTRADOR — e IMPORTAR NAO E MANDAR CORRER. O mapa nao mede quem lhe da a ordem, e por isso nao a inventa. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | coleta/italy_executor.py:88; ferramentas/big_collection/bc5_big_collection.py:39; ferramentas/big_collection/onda_web.py:46 |
...
| **o que sai · dado** | C-MICRO-SOCIAL |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 2 · saem 25 |
| **arestas provadas** | entram 2 · saem 25 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
| **data plane** | entram 0 · saem 1 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
...
| | |
|---|---|
| **peça real** | `guarda/sql_conferir.py`, `supabase/consultas/ADAMA-ES-CATALOGO-14-PERGUNTAS.sql`, `supabase/desfazer/033_desfazer.sql`, `supabase/ensaios/ADAMA-ES-ENSAIO-CINCO-CASOS.sql`, `supabase/ensaios/CAPTURA-AS-OF-DUAS-CAPTURAS.sql` _(e mais 51)_ |
| **papel** | UNKNOWN · medido no plano UNKNOWN |
| **dono** | ENGENHARIA |
| **status operacional** | yellow — algum workflow ou a cadeia canonica manda rodar isto.  Mas ha 12 ficheiro(s) novos que nunca foram lidos por gente. |
...
### `C-CAPA-MATERIA` · Capa no lugar de materia (1.a onda) — diagnostico, filtro de pagina institucional e previsao do MICRO

| | |
|---|---|
| **peça real** | `PERGUNTA-BOT-LUCIANO-HORIZONTE-DE-REVISITA.md`, `RELATORIO-ALVOS-NOVOS.md`, `RELATORIO-CAPA-MATERIA.md`, `RELATORIO-CONTRATOS-AJUSTE.md`, `scripts/capa_materia/CONFIRMACAO-ISTAT-V1.json` _(e mais 20)_ |
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | ENGENHARIA · INTELIGENCIA |
| **status operacional** | yellow — existe teste que exercita isto.  Mas ha 25 ficheiro(s) novos que nunca foram lidos por gente. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | ferramentas/big_collection/coorte_unica.py:42; ferramentas/integra_onda2/final/ensaio_integra.sh:61; ferramentas/legacy99v2/mutacao.py:55 |
| **porquê** | estas pecas importam-na — C-COORTE-BIG-COLLECTION · C-COORTE-MICRO-FUNIL · C-INTEGRA-ONDA2 · C-IT-CONTRATOS · C-LEGACY-99 — e IMPORTAR NAO E MANDAR CORRER. O mapa nao mede quem lhe da a ordem, e por isso nao a inventa. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **arestas provadas** | entram 7 · saem 11 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
| **data plane** | entram 0 · saem 1 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
...
| **status operacional** | yellow — existe, mas nada no repositorio manda rodar nem importa — pode estar desligado. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | scripts/micro_coleta/micro_coleta.py:237; tests/test_aplicar_desbloqueio.py:16 |
...
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 9 · saem 0 |
| **arestas provadas** | entram 9 · saem 0 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
| **data plane** | entram 0 · saem 0 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
...
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 10 · saem 5 |
| **arestas provadas** | entram 8 · saem 5 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
| **data plane** | entram 0 · saem 0 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
| **prova das ligações** | CODE 13 · NÃO SEI 2 |
| **lei da Bíblia** | COL-LAW-028/029 · a fonte tem saude, e o drift tem controlo negativo |
| **VEREDITO** | **UNKNOWN** — nada medido diz quem lhe da a ordem |
...
| **status operacional** | yellow — existe, mas nada no repositorio manda rodar nem importa — pode estar desligado. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | ferramentas/onda3_pacote/ensaio_onda3.sh:67 |
| **porquê** | estas pecas importam-na — C-PACOTE-ONDA3 — e IMPORTAR NAO E MANDAR CORRER. O mapa nao mede quem lhe da a ordem, e por isso nao a inventa. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **prova de quem ativa** | .github/workflows/system-map.yml:552 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 6 · saem 14 |
...
| **papel** | MEASUREMENT_INSTRUMENT · medido no plano CODE |
| **dono** | INTELIGENCIA · TECNICO_CIENCIA |
| **status operacional** | yellow — existe teste que exercita esta lei. NENHUM modulo de runtime a importa — a lei esta escrita e nao esta a ser aplicada (DECLARED_RULE_NOT_ENFORCED).  Mas 1 fiche |
| **QUEM ATIVA** | **SO_A_PROVA_A_CORRE** — C-TESTES |
...
| **arestas no mapa** | entram 12 · saem 2 |
| **arestas provadas** | entram 12 · saem 2 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
| **data plane** | entram 0 · saem 0 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
...
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | ENGENHARIA · INTELIGENCIA |
| **status operacional** | yellow — existe teste que exercita isto.  Mas ha 23 ficheiro(s) novos que nunca foram lidos por gente. |
| **QUEM ATIVA** | **SO_A_PROVA_A_CORRE** — C-TESTES |
...
| **o que sai · dado** | C-SCRAP-SOCIAL |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 18 · saem 36 |
| **arestas provadas** | entram 18 · saem 35 |
| **OBSERVADAS** | 3 — corrida `?` |
| **control plane** | entram 3 · saem 7 |
| **data plane** | entram 0 · saem 1 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
| **prova das ligações** | CODE 50 · OBSERVED 3 · NÃO SEI 1 |
...
| **status operacional** | yellow — outra peca do sistema importa isto para funcionar.  Mas ha 1 ficheiro(s) novos que nunca foram lidos por gente. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | orquestrador/orquestrador.py:62; provas/tempo_e_lugar_replay.py:105; tests/test_a_porta_cli_liga_o_banco.py:42 |
| **porquê** | estas pecas importam-na — C-ORQUESTRADOR — e IMPORTAR NAO E MANDAR CORRER. O mapa nao mede quem lhe da a ordem, e por isso nao a inventa. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **QUEM ATIVA** | **PECA_INTERNA** — C-INTEGRA-ONDA2, C-PACOTE-ONDA3 |
| **prova de quem ativa** | ferramentas/integra_onda2/final/ensaio_integra.sh:61; ferramentas/onda3_pacote/ensaio_onda3.sh:123; ferramentas/onda3_pacote/ensaio_onda3_v2.sh:167 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | `candidatas/ITALY-SOURCE-MASTER-V1.json`, `candidatas/italy_profiles.mjs`, `coleta/italy_pilot_collect.mjs` |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **arestas provadas** | entram 13 · saem 19 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 2 · saem 0 |
| **data plane** | entram 0 · saem 0 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
| **prova das ligações** | CODE 32 · NÃO SEI 6 |
| **lei da Bíblia** | COL-LAW-031/032/033/034 · tempo, geografia, procedencia, identidade |
| **VEREDITO** | **OK** — activador provado, e o mapa mostra-o |
...
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 4 · saem 14 |
| **arestas provadas** | entram 2 · saem 8 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
| **data plane** | entram 0 · saem 0 |
| **prova da peça** | DECLARED YES · CODE YES · OBSERVED UNKNOWN · PROVEN YES _(no plano CODE)_ |
| **prova das ligações** | CODE 10 · NÃO SEI 8 |
| **lei da Bíblia** | COL-LAW-031/032/033/034 · tempo, geografia, procedencia, identidade |
| **VEREDITO** | **UNKNOWN** — nada medido diz quem lhe da a ordem |
...
| **arestas no mapa** | entram 4 · saem 7 |
...
| **papel** | UNKNOWN · medido no plano UNKNOWN |
| **dono** | UNKNOWN |
| **status operacional** | green — 6 acao(oes) NOMEIAM este canal no codigo, cada uma com ficheiro e linha. Isto e rota DECLARADA: nao diz que algo passou por aqui, so que o caminho esta escrito. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | — NÃO SEI |
| **porquê** | nenhuma rota medida abre este canal, e ninguem o corre. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | C-COLETA-YOUTUBE, C-CORPUS, C-EU-REGULATORIO-COLETA, C-FONTES-EU, C-ROTULOS, C-SCRAP-SOCIAL |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 0 · saem 6 |
| **arestas provadas** | entram 0 · saem 0 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
| **data plane** | entram 0 · saem 6 |
| **prova da peça** | DECLARED YES · CODE UNKNOWN · OBSERVED UNKNOWN · PROVEN UNKNOWN |
