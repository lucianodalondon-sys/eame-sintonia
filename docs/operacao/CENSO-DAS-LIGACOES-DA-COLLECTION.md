...
```
HEAD_DA_MEDICAO  87eca8655d36250311024f01d543fd5033279eef
BRANCH           claude/system-map-collection-truth-v1
GERADO_EM        2026-09-14T04:58:14+00:00
CARDS            64
...
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | coleta/comunicacao_coleta.py:58; coleta/instagram_coleta.py:71; coleta/youtube_oficial.py:315 |
| **porquê** | estas pecas importam-na — C-COLETA-INSTAGRAM · C-COLETA-PUBLICA · C-RASTRO · C-SCRAP-SOCIAL · C-SENSOR-COLETA — e IMPORTAR NAO E MANDAR CORRER. O mapa nao mede quem lhe da a ordem, e por isso nao a inventa. |
...
| **arestas no mapa** | entram 2 · saem 9 |
...
| **prova de quem ativa** | .github/workflows/sintonia-scrap.yml:224; .github/workflows/sintonia-scrap.yml:234 _(plano CODE)_ |
...
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | INTELIGENCIA · DESENVOLVIMENTO_MERCADO |
| **status operacional** | green — algum workflow ou a cadeia canonica manda rodar isto. |
| **QUEM ATIVA** | **PECA_INTERNA** — C-CI-COLETA, C-ORQUESTRADOR |
| **prova de quem ativa** | .github/workflows/comunicacao-publica.yml:146; .github/workflows/comunicacao-publica.yml:147; pedido/receitas.py:152 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | V-FACEBOOK, V-INSTAGRAM, V-LINKEDIN, V-YOUTUBE |
...
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | TECNICO_CIENCIA · INTELIGENCIA |
| **status operacional** | green — algum workflow ou a cadeia canonica manda rodar isto. |
| **QUEM ATIVA** | **PECA_INTERNA** — C-SINTONIA-SCRAP |
| **prova de quem ativa** | .github/workflows/sintonia-scrap.yml:243; .github/workflows/sintonia-scrap.yml:246 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
...
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | TECNICO_CIENCIA · DESENVOLVIMENTO_MERCADO |
...
| **prova de quem ativa** | pedido/receitas.py:80; orquestrador/orquestrador.py:359 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
...
| **porquê** | estas pecas importam-na — C-DERIVACAO-FORWARD · C-ESTRADA-PDF · C-FRONTEIRA-TELEMETRIA — e IMPORTAR NAO E MANDAR CORRER. O mapa nao mede quem lhe da a ordem, e por isso nao a inventa. |
...
| **QUEM ATIVA** | **PECA_INTERNA** — C-ORQUESTRADOR |
| **prova de quem ativa** | pedido/receitas.py:111; orquestrador/orquestrador.py:359 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | V-HTTP |
...
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | coleta/golden_path_pdf.py:51; coleta/rota_forward_documento.py:51; orquestrador/orquestrador.py:56 |
...
| **status operacional** | yellow — outra peca do sistema importa isto para funcionar.  Mas 2 ficheiro(s) mudaram depois de a descricao ter sido conferida — precisa de releitura humana. |
| **QUEM ATIVA** | **PECA_INTERNA** — C-ORQUESTRADOR |
| **prova de quem ativa** | pedido/receitas.py:124; orquestrador/orquestrador.py:359 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **status operacional** | green — outra peca do sistema importa isto para funcionar. |
| **QUEM ATIVA** | **PECA_INTERNA** — C-ORQUESTRADOR |
| **prova de quem ativa** | pedido/receitas.py:97; orquestrador/orquestrador.py:359 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | V-HTTP |
...
| **arestas provadas** | entram 3 · saem 9 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 1 · saem 0 |
| **data plane** | entram 1 · saem 1 |
| **VEREDITO** | **OK** — activador provado, e o mapa mostra-o |

### `C-SCRAP-SOCIAL` · Executor do SCRAP · a aquisicao social

| | |
|---|---|
| **peça real** | `coleta/social_envelope.py`, `coleta/social_persistencia.py`, `coleta/social_rotas.py`, `coleta/social_scrap.py`, `coleta/youtube_oficial.py` |
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
...
| **QUEM ATIVA** | **PECA_INTERNA** — C-ROTA-M2, C-SCRAP-ROTA |
| **prova de quem ativa** | .github/workflows/scrap-social.yml:107; .github/workflows/scrap-social.yml:108; tests/test_m2_rota_forward.py:1 _(plano OBSERVED)_ |
| **porquê** | uma corrida medida chamou esta peca — e nao so uma linha que diz que podia chamar. |
| **o que entra · dado** | C-DERIVACAO-FORWARD, V-HTTP, V-YOUTUBE |
...
| **status operacional** | yellow — existe, mas nada no repositorio manda rodar nem importa — pode estar desligado. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | coleta/italy_probe.mjs:23; provas/a_autoridade_da_fonte.py:61; provas/a_rota_m2_atravessa.py:154 |
...
| **prova de quem ativa** | system-map/scripts/scan_sources.py:371 _(plano CODE)_ |
| **porquê** | na coleta, NINGUEM a manda correr: quem a abre vive todo em Z-PROVA — provas e instrumentos de medicao. A peca esta construida e medida, e nao esta no caminho de coleta nenhuma. UMA PORTA POR ONDE SO PASSA QUEM A VEIO MEDIR AINDA NAO E UMA PORTA. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **prova de quem ativa** | .github/workflows/apify-conexao.yml:68; .github/workflows/apify-sensores.yml:117; .github/workflows/sintonia-scrap.yml:216 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **status operacional** | green — outras pecas importam ou carregam isto. |
| **QUEM ATIVA** | **PECA_INTERNA** — C-SINTONIA-SCRAP |
| **prova de quem ativa** | .github/workflows/sintonia-scrap.yml:174 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| | |
|---|---|
| **peça real** | `ferramentas/instagram_transcrever.py`, `ferramentas/youtube_transcrever.py` |
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | ENGENHARIA · TECNICO_CIENCIA |
| **status operacional** | green — algum workflow ou a cadeia canonica manda rodar isto. |
| **QUEM ATIVA** | **PECA_INTERNA** — C-SINTONIA-SCRAP |
| **prova de quem ativa** | .github/workflows/sintonia-scrap.yml:237; .github/workflows/sintonia-scrap.yml:248 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **papel** | STORAGE · medido no plano CODE |
| **dono** | UNKNOWN |
| **status operacional** | yellow — 23 bases oficiais com ficha e 44 contas publicas mapeadas. Mas so 5 das bases tem contrato de busca escrito: nas outras 18, hoje so uma pessoa consegue ir la —  |
| **QUEM ATIVA** | **NAO_SE_ATIVA** |
...
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 0 · saem 16 |
| **arestas provadas** | entram 0 · saem 12 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
...
| | |
|---|---|
| **peça real** | `guarda/memoria_descartavel.py`, `guarda/portas_live.py`, `guarda/preservar_coleta.py` |
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | ENGENHARIA |
...
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | coleta/ingresso.py:78; guarda/preservar_derivado.py:55; provas/a_fase_10_entra_no_acervo.py:504 |
| **porquê** | estas pecas importam-na — C-DONO-DO-DERIVADO · C-INGRESSO — e IMPORTAR NAO E MANDAR CORRER. O mapa nao mede quem lhe da a ordem, e por isso nao a inventa. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
...
| **status operacional** | green — outra peca do sistema importa isto para funcionar. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | coleta/executor_texto_de_pdf.py:256; guarda/memoria_descartavel.py:43; provas/derived_artifact_no_postgres.py:350 |
...
| **status operacional** | yellow — existe, mas nada no repositorio manda rodar nem importa — pode estar desligado. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | coleta/italy_executor.py:87; medidas/padrao_da_coleta.py:65; provas/italy_pilot_negativos.mjs:30 |
...
| **prova de quem ativa** | .github/workflows/scrap-social.yml:107; .github/workflows/security-check.yml:58 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| | |
|---|---|
| **peça real** | `guarda/sql_conferir.py`, `supabase/consultas/ADAMA-ES-CATALOGO-14-PERGUNTAS.sql`, `supabase/ensaios/ADAMA-ES-ENSAIO-CINCO-CASOS.sql`, `supabase/ensaios/CAPTURA-AS-OF-DUAS-CAPTURAS.sql`, `supabase/ensaios/CICATRIZES-LOCALIZACAO-E-RELEVANCIA.sql` _(e mais 44)_ |
| **papel** | UNKNOWN · medido no plano UNKNOWN |
| **dono** | ENGENHARIA |
| **status operacional** | yellow — algum workflow ou a cadeia canonica manda rodar isto.  Mas ha 5 ficheiro(s) novos que nunca foram lidos por gente. |
| **QUEM ATIVA** | **PECA_INTERNA** — C-CADEIA-V21 |
| **prova de quem ativa** | motor/cadeia_canonica.sh:195 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **prova de quem ativa** | .github/workflows/system-map.yml:525 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 5 · saem 9 |
| **arestas provadas** | entram 5 · saem 9 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
| **data plane** | entram 0 · saem 0 |
| **VEREDITO** | **OK** — contrato ou acervo: consulta-se, nao corre |
...
| **prova de quem ativa** | .github/workflows/comunicacao-publica.yml:139 _(plano CODE)_ |
| **porquê** | ha peca no mapa que manda esta correr, e ha linha de codigo que o prova. CAN DO: a linha existe; que a corrida tenha acontecido e outra pergunta. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **papel** | UNKNOWN · medido no plano UNKNOWN |
| **dono** | ENGENHARIA |
| **status operacional** | green — o sistema importa esta lei em runtime para decidir: C-ORQUESTRADOR, C-RECEITAS. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | orquestrador/orquestrador.py:52; pedido/receitas.py:46; provas/testa_coleta_canonica.py:31 |
...
| **o que sai · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que sai · ficheiros** | — NÃO SEI |
| **arestas no mapa** | entram 0 · saem 4 |
| **arestas provadas** | entram 0 · saem 4 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
| **data plane** | entram 0 · saem 0 |
| **VEREDITO** | **UNKNOWN** — nada medido diz quem lhe da a ordem |
...
| **status operacional** | yellow — outra peca do sistema importa isto para funcionar.  Mas 1 ficheiro(s) mudaram depois de a descricao ter sido conferida — precisa de releitura humana. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | orquestrador/orquestrador.py:53; provas/o_corte_de_cr1.py:59; system-map/scripts/censo_das_estradas_it.py:693 |
...
| | |
|---|---|
| **peça real** | `docs/fontes/ITALY-SOURCE-CONTRACT-MATRIX-V1.md`, `regras/italy_contract_test.mjs`, `regras/italy_contracts.mjs`, `regras/italy_pilot_guards.mjs`, `regras/italy_scheduling_guards.mjs` _(e mais 1)_ |
| **papel** | MEASUREMENT_INSTRUMENT · medido no plano CODE |
| **dono** | ENGENHARIA · INTELIGENCIA |
| **status operacional** | green — o sistema importa esta lei em runtime para decidir: C-IT-COLETA. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | candidatas/italy_write_matrix.mjs:2; coleta/italy_pilot_collect.mjs:38; coleta/italy_pilot_collect.mjs:38 |
...
| **papel** | MEASUREMENT_INSTRUMENT · medido no plano CODE |
| **dono** | TECNICO_CIENCIA · DESENVOLVIMENTO_MERCADO |
| **status operacional** | green — o sistema importa esta lei em runtime para decidir: C-COLETA-YOUTUBE, C-RELEVANCIA. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | coleta/youtube_relevancia.py:75; leis/regua_italia.py:57; motor/pacote_convergencia.py:101 |
| **porquê** | estas pecas importam-na — C-COLETA-YOUTUBE · C-RELEVANCIA · C-V21-CRUZAMENTO — e IMPORTAR NAO E MANDAR CORRER. O mapa nao mede quem lhe da a ordem, e por isso nao a inventa. |
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
...
| **arestas no mapa** | entram 2 · saem 5 |
| **arestas provadas** | entram 2 · saem 5 |
| **OBSERVADAS** | 0 |
| **control plane** | entram 0 · saem 0 |
| **data plane** | entram 0 · saem 0 |
| **VEREDITO** | **UNKNOWN** — nada medido diz quem lhe da a ordem |
...
| **papel** | OPERATIONAL_STEP · medido no plano CODE |
| **dono** | ENGENHARIA · INTELIGENCIA |
| **status operacional** | yellow — o sistema importa esta lei em runtime para decidir: C-COLETA-BASE, C-COLETA-INSTAGRAM, C-ESTRADA-PDF, C-ORQUESTRADOR.  Mas 1 ficheiro(s) mudaram depois de a des |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | coleta/coletor.py:76; coleta/golden_path_pdf.py:52; coleta/instagram_janela.py:74 |
...
| **arestas no mapa** | entram 0 · saem 15 |
...
| **o que entra · dado** | — NÃO SEI: nenhuma aresta de dado medida |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | C-COLETA-INSTAGRAM, C-COLETA-YOUTUBE, C-CORPUS, C-FONTES-EU, C-ROTULOS, C-SCRAP-SOCIAL |
| **o que sai · ficheiros** | — NÃO SEI |
...
| **o que entra · dado** | C-AS-FONTES |
| **o que entra · ficheiros** | — NÃO SEI |
| **o que sai · dado** | C-COLETA-PUBLICA, C-COLETA-YOUTUBE, C-SCRAP-SOCIAL |
| **o que sai · ficheiros** | — NÃO SEI |
