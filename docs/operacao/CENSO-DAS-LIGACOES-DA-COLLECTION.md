...
```
HEAD_DA_MEDICAO  8f91441cbaf1c749970633bc682e6daf67804f71
BRANCH           claude/publication-time-source-location-ux4cuc
GERADO_EM        2026-09-25T14:13:07+00:00
CARDS            99
...
| **status operacional** | yellow — outra peca do sistema importa isto para funcionar.  Mas 1 ficheiro(s) mudaram depois de a descricao ter sido conferida — precisa de releitura humana. |
| **QUEM ATIVA** | **NAO_SEI** |
| **prova de quem ativa** | coleta/executor_texto_de_html.py:604; coleta/executor_texto_de_pdf.py:299; coleta/executor_transcricao_midia.py:303 |
