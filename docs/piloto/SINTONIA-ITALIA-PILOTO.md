...
> **CORREÇÃO DO PASSO 03 — este não é o leitor canónico da casa.**
>
> Os 90 pares acima foram capturados em **2026-08-30**. Cinco dias depois, em
> **2026-09-04**, a casa publicou `data/samples/IT-ROTULOS-V1/IT-ROTULOS-PARES-V3.json`:
> **2.928 pares**, `it_rotulo_parser/3.4.0`, `ESTADO: PUBLICADO — passou o portão
> IT-ROTULOS-PORTAO-V1`, medido contra um gabarito de 30 rótulos lido à mão.
>
> A limitação declarada logo acima — *«o dicionário é espanhol, `Scaphoideus` não está
> nele»* — **já não vale**: é exactamente o que o leitor canónico resolveu. Ler este
> parágrafo como estado da arte seria rebaixar leitura que passou portão.
>
> ```
> LEITOR CANÓNICO   IT-ROTULOS-PARES-V3 · 2.928 pares · portão PASS
> ESTE ARTEFACTO    LEGACY_READER / HISTORICAL_INPUT · CANONICAL_AUTHORITY = NO
> SUBSUMIDO         PARCIAL — 37 de 49 linhas de uso, após traduzir a cultura EN→IT
> ```
>
> As 12 linhas não cobertas (barbabietola, sorgo, riso, frumento em 008189, 014479,
> 018067, 018270, 018271, 018277, 018279, 019095) e os campos que só existem aqui
> (`DOSES`, `INTERVAL_DAYS`, `MAX_APPLICATIONS`, `EVIDENCE`) entram como
> **`CANDIDATE_INPUT_TO_CANONICAL_READER`** — candidato a reprocessar, nunca par
> publicado. `OLDER_SMALLER_READER != CANONICAL_READER`.
