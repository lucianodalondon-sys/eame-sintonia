...
9. **"Every number leads back to a source file, a date and an original statement — and the
   system refuses to answer when it cannot."** → <!--M:TEST_COUNT_CURRENT-->2.701<!--/M--> provas automatizadas; 35 perguntas de benchmark,
   system refuses to answer when it cannot."** → <!--M:TEST_COUNT_CURRENT-->2.888<!--/M--> provas automatizadas; 35 perguntas de benchmark,
