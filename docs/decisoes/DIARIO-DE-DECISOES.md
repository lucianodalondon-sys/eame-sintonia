...
### Nota de reconciliação — P0.2 · PASSO 02

As 17 decisões abaixo vieram de `claude/eame-agro-creators-map-77c4ld` e foram **renumeradas**
de `D-013…D-029` para `D-027…D-043`. Os dois lados criaram, em paralelo e a partir da mesma base,
decisões diferentes com os mesmos identificadores — 14 colisões. Renumerar as recebidas (e não as
canônicas) foi a resolução com custo zero de citação: nenhum ficheiro fora deste diário cita
`D-013…D-026`, e nenhum portão valida o namespace. Nenhuma decisão foi perdida de nenhum lado.

### D-027 — Creator e sensor são dois papéis, e nunca uma ficha só
...
### D-028 — Produto final não prova lavoura
...
### D-029 — Suspeita nossa nunca vira veredito sozinha
...
### D-030 — Empresa de defensivo usando creator ≠ ativação de produto fitossanitário
...
### D-031 — No runner Windows, urllib no lugar de curl
...
### D-032 — Ausência observada num corpus não é ausência no mercado
...
### D-033 — Tipo de relação com marca não é escada
...
### D-034 — Namespace, não lock, para missões concorrentes
...
### D-035 — Identidade primária antes de conteúdo, sempre
...
### D-036 — Hub bom é o que revela gente, não o que tem prestígio
...
### D-037 — Menção em hub não dá país, nem papel, nem cultura
...
### D-038 — Pecuária sai do mapa vegetal sem sair da base
...
### D-039 — Conta de empresa agrícola não é creator-pessoa
...
### D-040 — Cultura casa por palavra inteira, nunca por substring
...
### D-041 — Isolamento de namespace é inteiro ou não é
...
### D-042 — O nome da métrica é parte do contrato
...
### D-043 — Um "não" medido é entrega, não fracasso
