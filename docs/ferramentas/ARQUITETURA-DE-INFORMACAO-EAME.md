...
STATUS:               **PROVED** — <!--M:SOURCE_ID_COUNT-->190<!--/M--> SOURCE_IDs fichados, 16 amostras com proveniência
                      obrigatória testada, <!--M:TEST_COUNT_CURRENT-->4.359<!--/M--> provas automatizadas
```
