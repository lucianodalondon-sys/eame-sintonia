...
STATUS:               **PROVED** — <!--M:SOURCE_ID_COUNT-->278<!--/M--> SOURCE_IDs fichados, 16 amostras com proveniência
                      obrigatória testada, <!--M:TEST_COUNT_CURRENT-->5.377<!--/M--> provas automatizadas
```
