...
STATUS:               **PROVED** — <!--M:SOURCE_ID_COUNT-->39<!--/M--> SOURCE_IDs fichados, 16 amostras com proveniência
                      obrigatória testada, <!--M:TEST_COUNT_CURRENT-->1.334<!--/M--> provas automatizadas
```
