...
STATUS:               **PROVED** — <!--M:SOURCE_ID_COUNT-->177<!--/M--> SOURCE_IDs fichados, 16 amostras com proveniência
                      obrigatória testada, <!--M:TEST_COUNT_CURRENT-->4.288<!--/M--> provas automatizadas
```
