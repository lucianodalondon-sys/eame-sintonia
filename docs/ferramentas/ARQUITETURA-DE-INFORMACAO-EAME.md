...
STATUS:               **PROVED** — <!--M:SOURCE_ID_COUNT-->277<!--/M--> SOURCE_IDs fichados, 16 amostras com proveniência
                      obrigatória testada, <!--M:TEST_COUNT_CURRENT-->5.350<!--/M--> provas automatizadas
```
