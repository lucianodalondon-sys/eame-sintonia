...
STATUS:               **PROVED** — <!--M:SOURCE_ID_COUNT-->38<!--/M--> SOURCE_IDs fichados, 16 amostras com proveniência
                      obrigatória testada, <!--M:TEST_COUNT_CURRENT-->682<!--/M--> provas automatizadas
```
