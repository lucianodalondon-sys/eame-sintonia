...
CURRENT_EVIDENCE:      <!--M:SOURCE_ID_COUNT-->40<!--/M--> SOURCE_IDs registrados, todos públicos; nenhuma conversa privada
...
CLAIM_TYPE:            D
CURRENT_STATUS:        **PROVED**
CURRENT_EVIDENCE:      16 dos <!--M:SOURCE_ID_COUNT-->40<!--/M--> SOURCE_IDs estão em NÃO SEI com motivo medido; nenhuma
