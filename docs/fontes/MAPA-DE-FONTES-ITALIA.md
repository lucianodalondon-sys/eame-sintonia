...
| `IT-T3-004` | Friuli-VG | HTML, seção "colture erbacee" | **YELLOW** | seção existe; nenhum bollettino de milho localizado |
...
| YELLOW | 3 (`IT-T3-004`, `IT-T3-005`, `IT-T3-001` herdado) |
| RED / bloqueada | 1 (`IT-T9-001`, adama.com) |
| NÃO SEI (não alcançada) | 1 (`IT-T1-001`, ISTAT) |
