...
| endereços que o código realmente chama | **605** |
| desses, publicados no mapa | **40** (truncados: 565) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **15** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **491** candidata(s) na fila,
