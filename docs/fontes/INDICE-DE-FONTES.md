...
| endereços que o código realmente chama | **794** |
| desses, publicados no mapa | **40** (truncados: 754) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **193** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **1099** candidata(s) na fila,
