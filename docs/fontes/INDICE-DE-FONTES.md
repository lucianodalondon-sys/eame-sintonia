...
| endereços que o código realmente chama | **620** |
| desses, publicados no mapa | **40** (truncados: 580) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **266** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **1172** candidata(s) na fila,
