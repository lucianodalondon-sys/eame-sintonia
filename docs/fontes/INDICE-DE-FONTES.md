...
| endereços que o código realmente chama | **306** |
| desses, publicados no mapa | **40** (truncados: 266) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **30** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **271** candidata(s) na fila,
