...
| endereços que o código realmente chama | **680** |
| desses, publicados no mapa | **40** (truncados: 640) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **46** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **952** candidata(s) na fila,
