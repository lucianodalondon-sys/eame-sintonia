...
| endereços que o código realmente chama | **610** |
| desses, publicados no mapa | **40** (truncados: 570) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **8** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **914** candidata(s) na fila,
