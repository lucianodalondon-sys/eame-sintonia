...
| endereços que o código realmente chama | **666** |
| desses, publicados no mapa | **40** (truncados: 626) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **29** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **505** candidata(s) na fila,
