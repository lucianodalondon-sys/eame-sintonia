...
| endereços que o código realmente chama | **447** |
| desses, publicados no mapa | **40** (truncados: 407) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **128** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **430** candidata(s) na fila,
