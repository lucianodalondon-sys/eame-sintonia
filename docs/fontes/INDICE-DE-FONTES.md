...
| endereços que o código realmente chama | **739** |
| desses, publicados no mapa | **40** (truncados: 699) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **212** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **702** candidata(s) na fila,
