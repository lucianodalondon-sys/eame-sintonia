...
| endereços que o código realmente chama | **613** |
| desses, publicados no mapa | **40** (truncados: 573) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **14** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **490** candidata(s) na fila,
