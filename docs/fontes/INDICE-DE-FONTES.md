...
| endereços que o código realmente chama | **699** |
| desses, publicados no mapa | **40** (truncados: 659) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **154** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **640** candidata(s) na fila,
