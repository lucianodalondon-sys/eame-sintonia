...
| endereços que o código realmente chama | **629** |
| desses, publicados no mapa | **40** (truncados: 589) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **272** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **1204** candidata(s) na fila,
