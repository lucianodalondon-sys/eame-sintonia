...
| endereços que o código realmente chama | **752** |
| desses, publicados no mapa | **40** (truncados: 712) |
...
|---|---|---|---|---|---|
| 1 | **CANDIDATA** | alguem viu que existe. Ninguem abriu ainda. | **177** | `candidatas/FONTES-CANDIDATAS.json` | abrir, olhar o que entrega e guardar um exemplo real |
...
Hoje há **1083** candidata(s) na fila,
