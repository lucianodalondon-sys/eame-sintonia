...
> **Sobre a identidade destes três números.** `IT-T8-001..003` foram emitidos uma vez, em
> `claude/it-social-sources-v1`, sobre uma base de trunk desatualizada (`cdb5c112`). Essa
> branch foi **descartada** e esta refaz o trabalho sobre o HEAD real (`195bdb7b`). Os
> mesmos números voltam para **as mesmas três fontes**, com a mesma evidência: isto é
> continuidade de identidade, **não** reciclagem — reciclar seria dar um número gasto a uma
> fonte *diferente*. Medido: `IT-T8-001..003` aparecem apenas no commit `59916c55` daquela
> branch, que **não** é ancestral do trunk; nenhum outro emissor os usou.
...
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T8-001/MANIFEST.json
