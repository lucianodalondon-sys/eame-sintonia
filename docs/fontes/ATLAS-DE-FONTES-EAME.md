...
> **Reconciliado na INTEGRAÇÃO-04A (2026-09-20, bancada `curator-04a-integration`, curator @ 376c0d9b).**
> Das 84 fichas, **18 entraram na tabela que o motor lê** (`regras/italy_contracts_onboarded.json`, com o manifesto de evidência em `data/samples/IT-SOURCE-SAMPLES/<ID>/MANIFEST.json`; os bytes ficam fora do Git — ver relatório):
> as HTML com canário PASS e rota permitida pelo `robots.txt`. **50** (YouTube) ficam
> `CONTRACT_READY_ROUTE_BLOCKED` com `BLOCK_REASON = ROBOTS_DISALLOWED_ROUTE` — a rota
> `feeds/videos.xml` está em Disallow; a ficha guarda a caracterização, não uma rota provada.
> **9** ficaram `CONTRACTED_CANARY_FAILED` (EMPTY_LIST) e **7** não têm contrato (`SEM_CONTRATO`).
> A linha `ESTADO_04A:` de cada ficha diz qual é qual. `FONTE REGISTADA != FONTE COLECTÁVEL`:
> nenhuma das 66 é alcançável pela rota canónica, e a frase «contrato executavel escrito» do
> parágrafo acima vale para 77 das 84.
...
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T5-039/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0020/esami-di-stato1, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T5-039/MANIFEST.json (bytes fora do Git)
...
ESTADO_04A:                   SEM_CONTRATO - SIM — ramo de indice (curadoria/italy_contracts_curator.json, SEM_CONTRATO); NÃO integrada como colectável
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY - publica em meses · sem entrada de VALOR: a Intelligence ainda nao existe e nao opina aqui
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T7-017/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0138/amostra, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T7-017/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
ESTADO_04A:                   CONTRACTED_CANARY_FAILED - canário de 2026-09-20: nenhum dos 113 enderecos da entrada casa com o padrao — EMPTY_LIST, como o contrato preve; NÃO integrada como colectável; volta à amostragem
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 4 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY_PROBE - ritmo nao medido: visita para medir, nao para colher · sem entrada de VALOR: a Intelligence ainda nao existe e
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T7-021/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0155/amostra, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T7-021/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY - publica em meses · sem entrada de VALOR: a Intelligence ainda nao existe e nao opina aqui
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T12-009/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0007/avvisi-e-bandi, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T12-009/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
ESTADO_04A:                   CONTRACTED_CANARY_FAILED - canário de 2026-09-20: nenhum dos 101 enderecos da entrada casa com o padrao — EMPTY_LIST, como o contrato preve; NÃO integrada como colectável; volta à amostragem
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY - publica em meses · sem entrada de VALOR: a Intelligence ainda nao existe e nao opina aqui
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T7-031/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0165/amostra, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T7-031/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 4 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY_PROBE - ritmo nao medido: visita para medir, nao para colher · sem entrada de VALOR: a Intelligence ainda nao existe e
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T10-018/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0059/frutta-il-mercato-non-da-piu-certezze, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T10-018/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
ESTADO_04A:                   CONTRACTED_CANARY_FAILED - canário de 2026-09-20: nenhum dos 112 enderecos da entrada casa com o padrao — EMPTY_LIST, como o contrato preve; NÃO integrada como colectável; volta à amostragem
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY - publica em meses · sem entrada de VALOR: a Intelligence ainda nao existe e nao opina aqui
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T12-013/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0011/agricoltura-tavolo-verde-sulla-siccita, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T12-013/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   DAILY - publica em dias ou dentro da semana · sem entrada de VALOR: a Intelligence ainda nao existe e nao opina aqui
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T5-049/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0024/women-stem-2026, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T5-049/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY - publica em meses · sem entrada de VALOR: a Intelligence ainda nao existe e nao opina aqui
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (UNKNOWN), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T7-033/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0174/amostra, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T7-033/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY_PROBE - ritmo nao medido: visita para medir, nao para colher · sem entrada de VALOR: a Intelligence ainda nao existe e
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T10-020/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0065/amostra, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T10-020/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY_PROBE - ritmo nao medido: visita para medir, nao para colher · sem entrada de VALOR: a Intelligence ainda nao existe e
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T10-021/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0004/89677, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T10-021/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
ESTADO_04A:                   CONTRACTED_CANARY_FAILED - canário de 2026-09-20: nenhum dos 34 enderecos da entrada casa com o padrao — EMPTY_LIST, como o contrato preve; NÃO integrada como colectável; volta à amostragem
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
ESTADO_04A:                   CONTRACTED_CANARY_FAILED - canário de 2026-09-20: nenhum dos 111 enderecos da entrada casa com o padrao — EMPTY_LIST, como o contrato preve; NÃO integrada como colectável; volta à amostragem
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
ESTADO_04A:                   CONTRACTED_CANARY_FAILED - canário de 2026-09-20: nenhum dos 61 enderecos da entrada casa com o padrao — EMPTY_LIST, como o contrato preve; NÃO integrada como colectável; volta à amostragem
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
ESTADO_04A:                   CONTRACTED_CANARY_FAILED - canário de 2026-09-20: nenhum dos 102 enderecos da entrada casa com o padrao — EMPTY_LIST, como o contrato preve; NÃO integrada como colectável; volta à amostragem
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
ESTADO_04A:                   CONTRACTED_CANARY_FAILED - canário de 2026-09-20: nenhum dos 144 enderecos da entrada casa com o padrao — EMPTY_LIST, como o contrato preve; NÃO integrada como colectável; volta à amostragem
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY - publica em meses · sem entrada de VALOR: a Intelligence ainda nao existe e nao opina aqui
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T8-008/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0054/amostra, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T8-008/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
ESTADO_04A:                   CONTRACTED_CANARY_FAILED - canário de 2026-09-20: nenhum dos 215 enderecos da entrada casa com o padrao — EMPTY_LIST, como o contrato preve; NÃO integrada como colectável; volta à amostragem
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY - publica em meses · sem entrada de VALOR: a Intelligence ainda nao existe e nao opina aqui
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T10-022/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0066/amostra, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T10-022/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY_PROBE - ritmo nao medido: visita para medir, nao para colher · sem entrada de VALOR: a Intelligence ainda nao existe e
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T7-040/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0141/palio-casina-2026, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T7-040/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY - publica em meses · sem entrada de VALOR: a Intelligence ainda nao existe e nao opina aqui
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T7-041/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0142/documenti-elezioni-2025, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T7-041/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   WEEKLY - publica em semanas · sem entrada de VALOR: a Intelligence ainda nao existe e nao opina aqui
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T7-042/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0143/amostra, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T7-042/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   WEEKLY - publica em semanas · sem entrada de VALOR: a Intelligence ainda nao existe e nao opina aqui
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T2-030/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0147/amostra, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T2-030/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 3 itens
```
...
INITIAL_COLLECTION_CADENCE:   MONTHLY_PROBE - ritmo nao medido: visita para medir, nao para colher · sem entrada de VALOR: a Intelligence ainda nao existe e
ADAMA_USE_CASE:               NAO SEI - relevancia tematica medida (YES), uso por definir
EVIDENCE:                     data/samples/IT-SOURCE-SAMPLES/IT-T7-043/MANIFEST.json (sha256 do exemplo; bytes fora do Git — capturados pelo curator como curadoria/evidencia/CAND-0161/agrofarma-e-federbio-lanciano-il-manifesto-per-il-biocontrollo, sha256 em curadoria/REAL-EXAMPLE-MANIFEST-V1.json)
ESTADO_04A:                   READY_FOR_COLLECTION - integrada em regras/italy_contracts_onboarded.json (INTEGRACAO-04A, 2026-09-20); manifesto de evidência em data/samples/IT-SOURCE-SAMPLES/IT-T7-043/MANIFEST.json (bytes fora do Git)
VERDICT:                      GREEN - fonte aberta, exemplo real capturado e padrao observado em 2 itens
```
