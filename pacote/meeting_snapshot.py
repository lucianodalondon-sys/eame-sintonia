...
"""O SNAPSHOT DA REUNIÃO · a única fonte de inteligência da interface.
    ...
    python3 pacote/meeting_snapshot.py --source-head <sha> [--cutoff ISO8601]
...
def main():
    ...
    snap = {
        ...
        'ENGINE_VERSION': 'motor/v21_oportunidades.py + v21_janelas.py + '
    ...
    with open(pjs, 'w', encoding='utf-8') as f:
        f.write('/* GERADO por pacote/meeting_snapshot.py — NAO EDITAR A MAO.\n'
