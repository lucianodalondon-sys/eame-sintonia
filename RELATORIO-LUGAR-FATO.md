# RELATÓRIO · LUGAR-E-TEMPO-DO-FATO (D61 + D62 + D63 + D64) · ramo `lugar-fato-v1`
...
- `tests/test_fato_do_texto.py` — **33 testes, verdes** (`py -m unittest tests.test_fato_do_texto`).
...
- `scripts/lugar_fato/mutar_fato_do_texto.py` → `MUTACAO-FATO-DO-TEXTO-V1.json`: **31 mutantes, 31 mortos**.
