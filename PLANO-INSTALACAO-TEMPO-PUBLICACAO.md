...
| testes | `tests/test_tempo_e_lugar_da_publicacao.py` | 41 testes; HTML reais de `data/collection-store/italy/`. |
...
python3 -m unittest tests/test_tempo_e_lugar_da_publicacao.py      # 41 OK
