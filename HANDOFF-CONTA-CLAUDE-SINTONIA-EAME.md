...
| **WORKING_TREE** | limpo |
| **TESTS** | `python3 -m unittest discover -s tests` → **515 testes, 0 falhas, 0 erros, 0 pulados** |
...
`tests/` inteiro: 515 testes que codificam as leis, não só o comportamento.
