...
| **WORKING_TREE** | limpo |
| **TESTS** | `python3 -m unittest discover -s tests` → **373 testes, 0 falhas, 0 erros, 0 pulados** |
...
`tests/` inteiro: <!--M:TEST_COUNT_CURRENT-->373<!--/M--> testes que codificam as leis, não só o comportamento.
...
```bash
# suíte canônica — <!--M:TEST_COUNT_CURRENT-->373<!--/M--> testes
