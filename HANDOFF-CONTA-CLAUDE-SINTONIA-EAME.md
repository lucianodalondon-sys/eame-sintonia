...
| **WORKING_TREE** | limpo |
| **TESTS** | `python3 -m unittest discover -s tests` → **669 testes, 0 falhas, 0 erros, 0 pulados** |
...
`tests/` inteiro: 669 testes que codificam as leis, não só o comportamento.
