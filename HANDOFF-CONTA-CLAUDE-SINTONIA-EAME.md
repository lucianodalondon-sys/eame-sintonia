...
| **WORKING_TREE** | limpo |
| **TESTS** | `python3 -m unittest discover -s tests` → **<!--M:TEST_COUNT_CURRENT-->839<!--/M--> testes descobertos = 816 passam + 6 falhas + 1 erro + 16 pulados · 0 nunca executados (DESCOBERTOS == EXECUTADOS). O dono da contagem e `scripts/v21_contagem_da_suite.py`** — as falhas sao anteriores a esta linha de missoes e estao classificadas em `docs/design/REVISAO-COMMERCIAL-PRIORITY-V11.md` |
