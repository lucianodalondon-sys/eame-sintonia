...
| **WORKING_TREE** | limpo |
| **TESTS** | `python3 -m unittest discover -s tests` → **391 testes, 0 falhas, 0 erros, 0 pulados** |
...
`tests/` inteiro: 391 testes que codificam as leis, não só o comportamento.
