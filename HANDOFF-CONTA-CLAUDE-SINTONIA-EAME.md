...
| **WORKING_TREE** | limpo |
| **TESTS** | `python3 -m unittest discover -s tests` → **<!--M:TEST_COUNT_CURRENT-->715<!--/M--> testes descobertos, 710 executados, 6 falhas, 2 erros, 14 pulados** — as falhas sao anteriores a esta linha de missoes e estao classificadas em `docs/design/REVISAO-COMMERCIAL-PRIORITY-V11.md` |
