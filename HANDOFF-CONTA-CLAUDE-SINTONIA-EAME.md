...
| **WORKING_TREE** | limpo |
| **TESTS** | `python3 -m unittest discover -s tests` → **307 testes, 0 falhas, 0 erros, 0 pulados** |
...
`tests/` inteiro: 307 testes que codificam as leis, não só o comportamento.
