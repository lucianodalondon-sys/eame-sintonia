...
| **WORKING_TREE** | limpo |
| **TESTS** | `python3 -m unittest discover -s tests` → **<!--M:TEST_COUNT_CURRENT-->2.701<!--/M--> testes carregados (1.645 correram; 3 falham a carregar), **10 falhas, 15 erros, 175 pulados** — medido em 2026-09-09 com o comando ao lado. Os numeros anteriores (6 falhas, 1 erro, 16 pulados) eram de 2026-08-29 e ficaram para tras: so o total tinha marcador de sincronizacao, e os outros tres nao, entao `--sync` actualizava um e deixava envelhecer os outros. **UM NUMERO COM DONO AO LADO DE TRES SEM DONO FAZ A FRASE INTEIRA MENTIR.** As falhas sao anteriores a esta linha de missoes e estao classificadas uma a uma em `docs/design/REVISAO-COMMERCIAL-PRIORITY-V11.md` §7. Um handoff que promete verde e entrega vermelho ensina a proxima conta a desconfiar do proprio contador. |
| **TESTS** | `python3 -m unittest discover -s tests` → **<!--M:TEST_COUNT_CURRENT-->2.888<!--/M--> testes carregados (1.645 correram; 3 falham a carregar), **10 falhas, 15 erros, 175 pulados** — medido em 2026-09-09 com o comando ao lado. Os numeros anteriores (6 falhas, 1 erro, 16 pulados) eram de 2026-08-29 e ficaram para tras: so o total tinha marcador de sincronizacao, e os outros tres nao, entao `--sync` actualizava um e deixava envelhecer os outros. **UM NUMERO COM DONO AO LADO DE TRES SEM DONO FAZ A FRASE INTEIRA MENTIR.** As falhas sao anteriores a esta linha de missoes e estao classificadas uma a uma em `docs/design/REVISAO-COMMERCIAL-PRIORITY-V11.md` §7. Um handoff que promete verde e entrega vermelho ensina a proxima conta a desconfiar do proprio contador. |
