...
| **WORKING_TREE** | limpo |
| **TESTS** | `python3 -m unittest discover -s tests` → **<!--M:TEST_COUNT_CURRENT-->368<!--/M--> testes, 0 falhas, 0 erros, 0 pulados** |
...
`tests/` inteiro: <!--M:TEST_COUNT_CURRENT-->368<!--/M--> testes que codificam as leis, não só o comportamento.
